...
window.addEventListener("load", function (e) {
  ...
  scroll.forEach(function (el) {
    el.addEventListener("scroll", function (e) {
      ...
      if (timer !== null) {
        clearTimeout(timer); //console.log("scrolling...");
...
document.addEventListener("DOMContentLoaded", function () {
  var sidebar = document.querySelectorAll(".sidebar"); //var zindex = 100;
...
window.addEventListener("load", function () {
  var btnToggle = document.querySelectorAll(".sidebar-toggle");
  btnToggle.forEach(function (el) {
