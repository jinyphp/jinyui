        ...
        <div class="row">
            ...
            <div class="col-lg-3 mb-3">
                ...
                <a class="d-inline-flex align-items-center mb-2 link-dark text-decoration-none" href="/"
                    aria-label="jinyui">
                    <span class="fs-5">JinyUIKit</span>
                </a>
            ...
            <div class="col-6 col-lg-2 offset-lg-1 mb-3">
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="mb-2"><a href="/jinyui">Demo</a></li>
                    <li class="mb-2"><a href="/themes">Themes</a></li>
                </ul>
            </div>
            ...
            <div class="col-6 col-lg-2 mb-3">
                <h5>Projects</h5>
                <ul class="list-unstyled">
                    <li class="mb-2"><a href="#">Jinyui</a></li>
                    <li class="mb-2"><a href="#">Bootstrap</a></li>
                    <li class="mb-2"><a href="#">Tailwind CSS</a></li>
                </ul>
            </div>
            <div class="col-6 col-lg-2 mb-3">
                <h5>Community</h5>
