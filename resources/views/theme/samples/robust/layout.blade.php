...
<div class="intro py-5 py-lg-9 position-relative text-white">
    <div class="bg-overlay-primary">
      <img src="https://robust.bootlab.io/img/photos/7.jpg" class="img-fluid img-cover" alt="Robust UI Kit" />
    </div>
          ...
          <div class="col-md-4">
            <div>
              <a href="pages-landing.html" class="link-unstyled">
                <img src="https://robust.bootlab.io/img/demos/landing-2.png" class="img-fluid shadow-sm" alt="Landing" />
              </a>
          ...
          <div class="col-md-4">
            <div>
              <a href="pages-dashboard.html" class="link-unstyled">
                <img src="https://robust.bootlab.io/img/demos/social-2.png" class="img-fluid shadow-sm" alt="Dashboard" />
              </a>
          ...
          <div class="col-md-4">
            <div>
              <a href="pages-general.html" class="link-unstyled">
                <img src="https://robust.bootlab.io/img/demos/careers.png" class="img-fluid shadow-sm" alt="Pages" />
              </a>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-5 ml-auto mt-4">
            <img src="https://robust.bootlab.io/img/ipad.png" class="img-fluid" alt="iPad" />
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="carousel-cell">
          <div class="container">
            <div class="row">
              <div class="col-md-10 mx-auto">
                <div class="media">
                  <img src="https://robust.bootlab.io/img/avatars/1.jpg" alt="Avatar" class="img-fluid rounded-circle mr-4" style="max-width:128px;" />
                  <div class="media-body">
        ...
        <div class="carousel-cell">
          <div class="container">
            <div class="row">
              <div class="col-md-10 mx-auto">
                <div class="media">
                  <img src="https://robust.bootlab.io/img/avatars/2.jpg" alt="Avatar" class="img-fluid rounded-circle mr-4" style="max-width:128px;" />
                  <div class="media-body">
                    <blockquote class="h3 mt-3 font-weight-normal">
                      “I can only recommend both this theme and the competent developer behind it to other people. Quick & helpful support! ”
                    </blockquote>
        ...
        <div class="carousel-cell">
          <div class="container">
            <div class="row">
              <div class="col-md-10 mx-auto">
                <div class="media">
                  <img src="https://robust.bootlab.io/img/avatars/3.jpg" alt="Avatar" class="img-fluid rounded-circle mr-4" style="max-width:128px;" />
                  <div class="media-body">
                    <blockquote class="h3 mt-3 font-weight-normal">
                      “I can only recommend both this theme and the competent developer behind it to other people. Quick & helpful support! ”
                    </blockquote>
        ...
        <div class="row">
          <div class="col-md-10 mx-auto">
            ...
            <div class="row align-items-center my-md-4">
              <div class="col">
                <img src="https://robust.bootlab.io/img/logos/sass.svg" class="img-fluid p-md-2" alt="Sass" />
              </div>
              <div class="col">
                <img src="https://robust.bootlab.io/img/logos/bootstrap.svg" class="img-fluid p-md-4" alt="Bootstrap" />
              </div>
              <div class="col">
                <img src="https://robust.bootlab.io/img/logos/jquery.svg" class="img-fluid" alt="jQuery" />
              </div>
              <div class="col">
                <img src="https://robust.bootlab.io/img/logos/webpack.svg" class="img-fluid p-md-3" alt="Webpack" />
              </div>
              <div class="col">
                <img src="https://robust.bootlab.io/img/logos/babel.svg" class="img-fluid" alt="Babel" />
              </div>
              <div class="col">
                <img src="https://robust.bootlab.io/img/logos/npm.svg" class="img-fluid" alt="Npm" />
              </div>
            </div>
          </div>
        </div>
