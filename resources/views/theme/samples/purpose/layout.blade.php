            ...
            <div class="navbar-nav align-items-center">
                ...
                <div>
                    <ul class="nav">
                        <li class="nav-item dropdown ml-lg-2">
                            <a class="nav-link px-0" href="https://preview.webpixels.io/purpose-website-ui-kit/#"
                                role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                data-offset="0,10">
                                <img alt="Image placeholder"
                                    src="https://preview.webpixels.io/purpose-website-ui-kit/assets/img/icons/flags/us.svg">
                                <span class="d-none d-lg-inline-block">United States</span>
                                <span class="d-lg-none">EN</span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-sm">
                                <a href="https://preview.webpixels.io/purpose-website-ui-kit/#"
                                    class="dropdown-item"><img alt="Image placeholder"
                ...
                <div class="ml-auto">
                    <ul class="nav">
                        <li class="nav-item">
                            <a class="nav-link"
                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/utility/support.html">Support</a>
                        </li>
                        <li class="nav-item">
                            <a href="https://preview.webpixels.io/purpose-website-ui-kit/#" class="nav-link"
                                data-action="omnisearch-open" data-target="#omnisearch"><i
                                    class="fas fa-search"></i></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link"
                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/shop/checkout-cart.html"><i
                                    class="fas fa-shopping-cart"></i></a>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link pr-0" href="https://preview.webpixels.io/purpose-website-ui-kit/#"
    ...
    <nav class="navbar navbar-main navbar-expand-lg navbar-transparent navbar-dark bg-dark" id="navbar-main">
        <div class="container px-lg-0">
            ...
            <a class="navbar-brand mr-lg-5" href="https://preview.webpixels.io/purpose-website-ui-kit/index.html">
                <img alt="Image placeholder"
                    src="https://preview.webpixels.io/purpose-website-ui-kit/assets/img/brand/white.png"
            ...
            <div class="collapse navbar-collapse" id="navbar-main-collapse">
                <ul class="navbar-nav align-items-lg-center">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link"
                            href="https://preview.webpixels.io/purpose-website-ui-kit/index.html">Overview</a>
                    </li>
                    <!-- Pages menu -->
                    <li class="nav-item dropdown dropdown-animate" data-toggle="hover">
                        <a class="nav-link dropdown-toggle" href="https://preview.webpixels.io/purpose-website-ui-kit/#"
                                    ...
                                    <a href="https://preview.webpixels.io/purpose-website-ui-kit/#"
                                        ...
                                        <div class="media d-flex align-items-center">
                                            ...
                                            <figure style="width: 50px;">
                                                <img alt="Image placeholder"
                                                    src="https://preview.webpixels.io/purpose-website-ui-kit/assets/img/icons/essential/detailed/Code_2.svg"
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/landing/agency.html">
                                                Agency
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/landing/app.html">
                                                App
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/landing/blog.html">
                                                Blog
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/landing/classic.html">
                                                Classic
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/landing/cloud-hosting.html">
                                                Cloud hosting
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/landing/digital.html">
                                                Digital
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/landing/event-music.html">
                                                Event music
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/landing/features.html">
                                                Features
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/landing/portfolio.html">
                                                Portfolio
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/landing/presentation.html">
                                                Presentation
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/landing/saas.html">
                                                Saas
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/landing/services.html">
                                                Services
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/landing/software.html">
                                                Software
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <li class="dropdown dropdown-animate dropdown-submenu" data-toggle="hover">
                                    <a href="https://preview.webpixels.io/purpose-website-ui-kit/#"
                                        ...
                                        <div class="media d-flex align-items-center">
                                            ...
                                            <figure style="width: 50px;">
                                                <img alt="Image placeholder"
                                                    src="https://preview.webpixels.io/purpose-website-ui-kit/assets/img/icons/essential/detailed/Code.svg"
                                                    class="svg-inject img-fluid" style="height: 50px;">
                                            </figure>
                                            <!-- Media body -->
                                            <div class="media-body ml-3">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/secondary/about-classic.html">
                                                About classic
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/secondary/about.html">
                                                About
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/secondary/blog.html">
                                                Blog
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/secondary/blog-article.html">
                                                Blog article
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/secondary/blog-masonry.html">
                                                Blog masonry
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/secondary/careers.html">
                                                Careers
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/secondary/careers-single.html">
                                                Careers single
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/secondary/contact.html">
                                                Contact
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/secondary/contact-simple.html">
                                                Contact simple
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/secondary/get-started.html">
                                                Get started
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/secondary/portfolio.html">
                                                Portfolio
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/secondary/portfolio-fullscreen.html">
                                                Portfolio fullscreen
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/secondary/pricing-charts.html">
                                                Pricing charts
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/secondary/pricing-comparison.html">
                                                Pricing comparison
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/secondary/pricing-simple.html">
                                                Pricing simple
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/secondary/services.html">
                                                Services
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/secondary/team.html">
                                                Team
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <li class="dropdown dropdown-animate dropdown-submenu" data-toggle="hover">
                                    <a href="https://preview.webpixels.io/purpose-website-ui-kit/#"
                                        ...
                                        <div class="media d-flex align-items-center">
                                            ...
                                            <figure style="width: 50px;">
                                                <img alt="Image placeholder"
                                                    src="https://preview.webpixels.io/purpose-website-ui-kit/assets/img/icons/essential/detailed/Secure_Files.svg"
                                                    class="svg-inject img-fluid" style="height: 50px;">
                                            </figure>
                                            <!-- Media body -->
                                            <div class="media-body ml-3">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/authentication/basic-login.html">
                                                Login
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/authentication/basic-register.html">
                                                Register
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/authentication/basic-recover.html">
                                                Recover
                                            </a>
                                        </li>
                                        ...
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/authentication/cover-login.html">
                                                Login
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/authentication/cover-register.html">
                                                Register
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/authentication/cover-recover.html">
                                                Recover
                                            </a>
                                        </li>
                                        <li class="dropdown-divider"></li>
                                        ...
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/authentication/simple-login.html">
                                                Login
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/authentication/simple-register.html">
                                                Register
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/authentication/simple-recover.html">
                                                Recover
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <li class="dropdown dropdown-animate dropdown-submenu" data-toggle="hover">
                                    <a href="https://preview.webpixels.io/purpose-website-ui-kit/#"
                                        ...
                                        <div class="media d-flex align-items-center">
                                            ...
                                            <figure style="width: 50px;">
                                                <img alt="Image placeholder"
                                                    src="https://preview.webpixels.io/purpose-website-ui-kit/assets/img/icons/essential/detailed/Task.svg"
                                                    class="svg-inject img-fluid" style="height: 50px;">
                                            </figure>
                                            <!-- Media body -->
                                            <div class="media-body ml-3">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/account/account-billing.html">
                                                Billing
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/account/account-notifications.html">
                                                Notifications
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/account/account-profile.html">
                                                Profile
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/account/account-profile-public.html">
                                                Profile public
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/account/account-settings.html">
                                                Settings
                                            </a>
                                        </li>
                                        <li class="dropdown-divider"></li>
                                        ...
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/account/board-connections.html">
                                                Connections
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/account/board-overview.html">
                                                Overview
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/account/board-projects.html">
                                                Projects
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/account/board-tasks.html">
                                                Tasks
                                            </a>
                                        </li>
                                        <li class="dropdown-divider"></li>
                                        ...
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/account/listing-orders.html">
                                                Orders
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/account/listing-projects.html">
                                                Projects
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/account/listing-users.html">
                                                Users
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <li class="dropdown dropdown-animate dropdown-submenu" data-toggle="hover">
                                    <a href="https://preview.webpixels.io/purpose-website-ui-kit/#"
                                        ...
                                        <div class="media d-flex align-items-center">
                                            ...
                                            <figure style="width: 50px;">
                                                <img alt="Image placeholder"
                                                    src="https://preview.webpixels.io/purpose-website-ui-kit/assets/img/icons/essential/detailed/Cart_Add_2.svg"
                                                    class="svg-inject img-fluid" style="height: 50px;">
                                            </figure>
                                            <!-- Media body -->
                                            <div class="media-body ml-3">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/shop/shop-landing.html">
                                                Landing
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/shop/shop-products.html">
                                                Products
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/shop/shop-product.html">
                                                Product
                                            </a>
                                        </li>
                                        <li class="dropdown-divider"></li>
                                        ...
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/shop/checkout-cart.html">
                                                Cart
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/shop/checkout-cart-empty.html">
                                                Cart empty
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/shop/checkout-customer.html">
                                                Customer
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/shop/checkout-payment.html">
                                                Payment
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/shop/checkout-shipping.html">
                                                Shipping
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <li class="dropdown dropdown-animate dropdown-submenu" data-toggle="hover">
                                    <a href="https://preview.webpixels.io/purpose-website-ui-kit/#"
                                        ...
                                        <div class="media d-flex align-items-center">
                                            ...
                                            <figure style="width: 50px;">
                                                <img alt="Image placeholder"
                                                    src="https://preview.webpixels.io/purpose-website-ui-kit/assets/img/icons/essential/detailed/Cog_Wheels.svg"
                                                    class="svg-inject img-fluid" style="height: 50px;">
                                            </figure>
                                            <!-- Media body -->
                                            <div class="media-body ml-3">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/utility/coming-soon.html">
                                                Coming soon
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/utility/error-404.html">
                                                Error 404
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/utility/faq.html">
                                                Faq
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/utility/support.html">
                                                Support
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/utility/topic.html">
                                                Topic
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="https://preview.webpixels.io/purpose-website-ui-kit/pages/utility/topic-simple.html">
                                                Topic simple
                                            </a>
                                        </li>
                                    </ul>
                    ...
                    <li class="nav-item dropdown dropdown-animate" data-toggle="hover">
                        <a class="nav-link dropdown-toggle" href="https://preview.webpixels.io/purpose-website-ui-kit/#"
                            role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Sections</a>
                        <div class="dropdown-menu dropdown-menu-xl dropdown-menu-arrow p-0">
                            <ul class="list-group list-group-flush">
                                <li>
                                    <a href="https://preview.webpixels.io/purpose-website-ui-kit/sections.html"
                                        class="list-group-item list-group-item-action" role="button">
                                        <div class="media d-flex align-items-center">
                                            <figure style="width: 50px;">
                                                <img alt="Image placeholder"
                                                    src="https://preview.webpixels.io/purpose-website-ui-kit/assets/img/icons/essential/detailed/Apps.svg"
                                                    class="svg-inject img-fluid" style="height: 50px;">
                                            </figure>
                                            <div class="media-body ml-3">
                            ...
                            <div class="dropdown-menu-links rounded-bottom delimiter-top p-4">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <a href="https://preview.webpixels.io/purpose-website-ui-kit/sections.html#headers"
                                            class="dropdown-item">Headers</a>
                                        <a href="https://preview.webpixels.io/purpose-website-ui-kit/sections.html#footers"
                                            class="dropdown-item">Footers</a>
                                        <a href="https://preview.webpixels.io/purpose-website-ui-kit/sections.html#blog"
                                            class="dropdown-item">Blog</a>
                                        <a href="https://preview.webpixels.io/purpose-website-ui-kit/sections.html#call-to-action"
                                            class="dropdown-item">Call to action</a>
                                        <a href="https://preview.webpixels.io/purpose-website-ui-kit/sections.html#clients"
                                            class="dropdown-item">Clients</a>
                                        <a href="https://preview.webpixels.io/purpose-website-ui-kit/sections.html#collapse"
                                            class="dropdown-item">Collapse</a>
                                    </div>
                                    <div class="col-sm-4">
                                        <a href="https://preview.webpixels.io/purpose-website-ui-kit/sections.html#covers"
                                            class="dropdown-item">Covers</a>
                                        <a href="https://preview.webpixels.io/purpose-website-ui-kit/sections.html#features"
                                            class="dropdown-item">Features</a>
                                        <a href="https://preview.webpixels.io/purpose-website-ui-kit/sections.html#milestone"
                                            class="dropdown-item">Milestone</a>
                                        <a href="https://preview.webpixels.io/purpose-website-ui-kit/sections.html#pricing"
                                            class="dropdown-item">Pricing</a>
                                        <a href="https://preview.webpixels.io/purpose-website-ui-kit/sections.html#projects"
                                            class="dropdown-item">Projects</a>
                                        <a href="https://preview.webpixels.io/purpose-website-ui-kit/sections.html#subscribe"
                                            class="dropdown-item">Subscribe</a>
                                    </div>
                                    <div class="col-sm-4">
                                        <a href="https://preview.webpixels.io/purpose-website-ui-kit/sections.html#swiper"
                                            class="dropdown-item">Swiper</a>
                                        <a href="https://preview.webpixels.io/purpose-website-ui-kit/sections.html#tables"
                                            class="dropdown-item">Tables</a>
                                        <a href="https://preview.webpixels.io/purpose-website-ui-kit/sections.html#team"
                                            class="dropdown-item">Team</a>
                                        <a href="https://preview.webpixels.io/purpose-website-ui-kit/sections.html#testimonials"
                                            class="dropdown-item">Testimonials</a>
                                        <a href="https://preview.webpixels.io/purpose-website-ui-kit/sections.html#video"
                                            class="dropdown-item">Video</a>
                                    </div>
                                </div>
                            </div>
                            <div class="delimiter-top py-3 px-4">
                                ...
                                <p class="mt-2 mb-0">
                                    Explore, switch, customize any component, section or page and make your website rich
                                    its full potential.
                                </p>
                            </div>
                        </div>
                ...
                <ul class="navbar-nav align-items-lg-center ml-lg-auto">
                    <li class="nav-item dropdown dropdown-animate" data-toggle="hover">
                        <a class="nav-link dropdown-toggle" href="https://preview.webpixels.io/purpose-website-ui-kit/#"
                            role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Docs</a>
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg dropdown-menu-arrow p-0">
                            <ul class="list-group list-group-flush">
                                <li>
                                    <a href="https://preview.webpixels.io/purpose-website-ui-kit/docs/index.html"
                                        class="list-group-item list-group-item-action" role="button">
                                        <div class="media d-flex align-items-center">
                                            <!-- SVG icon -->
                                            <figure style="width: 50px;">
                                                <img alt="Image placeholder"
                                                    src="https://preview.webpixels.io/purpose-website-ui-kit/assets/img/icons/essential/detailed/DOC_File.svg"
                                                    class="svg-inject img-fluid" style="height: 50px;">
                                            </figure>
                                            <!-- Media body -->
                                            <div class="media-body ml-3">
                                ...
                                <li>
                                    <a href="https://preview.webpixels.io/purpose-website-ui-kit/docs/components/index.html"
                                        class="list-group-item list-group-item-action" role="button">
                                        <div class="media d-flex align-items-center">
                                            <!-- SVG icon -->
                                            <figure style="width: 50px;">
                                                <img alt="Image placeholder"
                                                    src="https://preview.webpixels.io/purpose-website-ui-kit/assets/img/icons/essential/detailed/Mobile_UI.svg"
                                                    class="svg-inject img-fluid" style="height: 50px;">
                                            </figure>
                                            <!-- Media body -->
                                            <div class="media-body ml-3">
                            ...
                            <div class="dropdown-menu-links rounded-bottom delimiter-top p-4">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <a href="https://preview.webpixels.io/purpose-website-ui-kit/docs/getting-started/installation.html"
                                            class="dropdown-item">Installation</a>
                                        <a href="https://preview.webpixels.io/purpose-website-ui-kit/docs/getting-started/file-structure.html"
                                            class="dropdown-item">File structure</a>
                                        <a href="https://preview.webpixels.io/purpose-website-ui-kit/docs/getting-started/build-tools.html"
                                            class="dropdown-item">Build tools</a>
                                        <a href="https://preview.webpixels.io/purpose-website-ui-kit/docs/getting-started/customization.html"
                                            class="dropdown-item">Customization</a>
                                    </div>
                                    <div class="col-sm-6">
                                        <a href="https://preview.webpixels.io/purpose-website-ui-kit/docs/getting-started/plugins.html"
                                            class="dropdown-item">Using plugins</a>
                                        <a href="https://preview.webpixels.io/purpose-website-ui-kit/docs/components/index.html"
                                            class="dropdown-item">Components</a>
                                        <a href="https://preview.webpixels.io/purpose-website-ui-kit/docs/plugins/animate.html"
                                            class="dropdown-item">Plugins</a>
                                        <a href="https://preview.webpixels.io/purpose-website-ui-kit/docs/support.html"
                    ...
                    <li class="nav-item d-lg-none d-xl-block">
                        <a class="nav-link"
                            href="https://preview.webpixels.io/purpose-website-ui-kit/docs/changelog.html"
                            target="_blank">What's new</a>
                    </li>
                    <li class="nav-item mr-0">
                        <a href="https://preview.webpixels.io/purpose-website-ui-kit/https://themes.getbootstrap.com/product/purpose-website-ui-kit/"
                            target="_blank" class="nav-link d-lg-none">Purchase now</a>
                        <a href="https://preview.webpixels.io/purpose-website-ui-kit/https://themes.getbootstrap.com/product/purpose-website-ui-kit/"
                            target="_blank"
                            class="btn btn-sm btn-white rounded-pill btn-icon rounded-pill d-none d-lg-inline-flex"
            ...
            <div class="row">
                <div class="col-sm-6">
                    <ul class="list-unstyled mb-0">
                        <li>
                            <a class="list-link" href="https://preview.webpixels.io/purpose-website-ui-kit/#">
...
<div class="main-content">
        ...
        <div class="pt-7 position-absolute middle right-0 col-lg-7 col-xl-6 d-none d-lg-block">
            <figure class="w-100" style="max-width: 1000px;">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    id="b163acb8-d7e3-44ae-95e8-546cddd31e63" data-name="Layer 1" width="1077.87" height="813.02"
                    viewBox="0 0 1077.87 813.02" class="injected-svg svg-inject img-fluid" style="height: 1000px;">
                    <defs>
                        <linearGradient id="198f78e2-ec49-403a-9acf-506373c5226e-18" x1="975.77" y1="484.92" x2="975.77"
                            y2="87.89" gradientTransform="translate(-77.03)" gradientUnits="userSpaceOnUse">
                        ...
                        <linearGradient id="6e777f18-a157-4954-9b1f-a7cbf36b1989-18" x1="649.11" y1="832.85" x2="649.11"
                            y2="382.11" gradientTransform="matrix(1, 0, 0, 1, 0, 0)"
                    ...
                    <ellipse cx="489.56" cy="532.53" rx="226.98" ry="10.36" fill="#510fa8" opacity="0.1"></ellipse>
                    <path
                    ...
                    <path
                        ...
                        transform="translate(-61.06 -43.49)" fill="#fff"></path>
                    <ellipse cx="979.99" cy="403.16" rx="14.27" ry="4.72" fill="#510fa8" opacity="0.1"></ellipse>
                    <ellipse cx="178.55" cy="651.82" rx="84.04" ry="13.79" fill="#510fa8" opacity="0.1"></ellipse>
                    <g opacity="0.1">
                        <path
                        ...
                        <g opacity="0.2">
                            <rect x="93.82" y="312.72" width="207.7" height="12.66" rx="5.67" ry="5.67"></rect>
                            <rect x="93.82" y="369.3" width="207.7" height="12.66" rx="5.67" ry="5.67"></rect>
                            <rect x="93.82" y="397.58" width="174.18" height="12.66" rx="5.67" ry="5.67"></rect>
                            <rect x="93.82" y="341.01" width="90.06" height="12.66" rx="5.67" ry="5.67"></rect>
                        </g>
                    </g>
                    <path
                        ...
                        transform="translate(-61.06 -43.49)" fill="#fff"></path>
                    <g opacity="0.2">
                        <rect x="96.06" y="311.6" width="207.7" height="12.66" rx="5.67" ry="5.67" fill="#510fa8">
                        </rect>
                        <rect x="96.06" y="368.18" width="207.7" height="12.66" rx="5.67" ry="5.67" fill="#510fa8">
                        </rect>
                        <rect x="96.06" y="396.47" width="174.18" height="12.66" rx="5.67" ry="5.67" fill="#510fa8">
                        </rect>
                        <rect x="96.06" y="339.89" width="90.06" height="12.66" rx="5.67" ry="5.67" fill="#510fa8">
                        </rect>
                    </g>
                    <path
                    ...
                    <path d="M229.42,440.53s-14.66,7.67-17.5,8.07S224.33,447,224.33,447Z"
                        transform="translate(-61.06 -43.49)" opacity="0.1"></path>
                    <path d="M241.38,446.51s-19.44,6.58-28,5.38C213.42,451.89,234.65,455.93,241.38,446.51Z"
                        transform="translate(-61.06 -43.49)" opacity="0.1"></path>
                    <path
                    ...
                    <g opacity="0.1">
                        <path d="M184.17,339.07c-.2-.7-.43-1.4-.67-2.09C183.7,337.68,183.93,338.38,184.17,339.07Z"
                            transform="translate(-61.06 -43.49)"></path>
                        <path
                    ...
                    <ellipse cx="495.06" cy="797.52" rx="26.93" ry="4.55" fill="#510fa8" opacity="0.1"></ellipse>
                    <path
                        ...
                        transform="translate(-61.06 -43.49)" fill="#510fa8"></path>
                    <ellipse cx="793.17" cy="764.92" rx="26.93" ry="4.55" fill="#510fa8" opacity="0.1"></ellipse>
                    <ellipse cx="848.09" cy="436.83" rx="77.55" ry="12.72" fill="#510fa8" opacity="0.1"></ellipse>
                    <path
                        ...
                        transform="translate(-61.06 -43.49)" fill="url(#198f78e2-ec49-403a-9acf-506373c5226e-18)">
                    </path>
                    <path
                    ...
                    <path d="M936,384.23s4.12-6,11.16-5.9,10.06-.79,10.06-.79-4.51,2.67-7.63,3S936,384.23,936,384.23Z"
                        transform="translate(-61.06 -43.49)" opacity="0.1"></path>
                    <path
                        d="M938.38,385.62s3.72-2.58,5.85-2.68,4-.3,4-.3a11.3,11.3,0,0,1-3.27,1.59C943.14,384.73,938.38,385.62,938.38,385.62Z"
                        transform="translate(-61.06 -43.49)" opacity="0.1"></path>
                    <path d="M939.17,387.4s5.61.45,5.66,1.94" transform="translate(-61.06 -43.49)" opacity="0.1"></path>
                    <path
                    ...
                    <path
                        ...
                        transform="translate(-61.06 -43.49)" opacity="0.1"></path>
                    <path d="M969.17,124.15a23.65,23.65,0,1,1-23.65-23.65A23.64,23.64,0,0,1,969.17,124.15Z"
                        transform="translate(-61.06 -43.49)" fill="#cc818c"></path>
                    <path
                    ...
                    <path d="M966.05,228.13s-32.73,1.34-39.27,11.61c0,0,8.48-4,16.06-2.83S966.05,228.13,966.05,228.13Z"
                        transform="translate(-61.06 -43.49)" opacity="0.1"></path>
                    <path d="M929.9,264s15.47,1,18.75-2.23,3.28-5.2,3.28-5.2Z" transform="translate(-61.06 -43.49)"
                        opacity="0.1"></path>
                    ...
                    <path d="M875.61,162.53s11.9,10.71,14.13,11.75C889.74,174.28,877.39,162.53,875.61,162.53Z"
                        transform="translate(-61.06 -43.49)" opacity="0.1"></path>
                    ...
                    <path
                        ...
                        transform="translate(-61.06 -43.49)" opacity="0.05"></path>
                    <path d="M888,451.32s14.88,2.73,17.06,3.32-.6,1.64-.6,1.64S890.83,453.85,888,451.32Z"
                        transform="translate(-61.06 -43.49)" opacity="0.1"></path>
                    <path d="M887.61,443.44c.24,0,10.11-2.78,12.24-7.54" transform="translate(-61.06 -43.49)"
                        opacity="0.1"></path>
                    ...
                    <path d="M913.59,313.57l10.55,27.82s1.49-17.9-1.66-23.26A9.29,9.29,0,0,0,913.59,313.57Z"
                        transform="translate(-61.06 -43.49)" opacity="0.05"></path>
                    <g opacity="0.1">
                    ...
                    <g opacity="0.1">
                        <path
                            ...
                            transform="translate(-61.06 -43.49)"></path>
                        <g opacity="0.2">
                            <rect x="608.09" y="106.09" width="191.66" height="11.68" rx="5.67" ry="5.67"></rect>
                            <rect x="608.09" y="158.29" width="158.15" height="11.68" rx="5.67" ry="5.67"></rect>
                            <rect x="608.09" y="132.19" width="113.85" height="11.68" rx="5.67" ry="5.67"></rect>
                        </g>
                    </g>
                    <path
                        ...
                        transform="translate(-61.06 -43.49)" fill="#fff"></path>
                    <g opacity="0.2">
                        <rect x="611.18" y="104.02" width="191.66" height="11.68" rx="5.67" ry="5.67" fill="#510fa8">
                        </rect>
                        <rect x="611.18" y="156.23" width="158.15" height="11.68" rx="5.67" ry="5.67" fill="#510fa8">
                        </rect>
                        <rect x="611.18" y="130.13" width="113.85" height="11.68" rx="5.67" ry="5.67" fill="#510fa8">
                        </rect>
                    </g>
                    <path
                    ...
                    <path
                        ...
                        transform="translate(-61.06 -43.49)" fill="#ffd037"></path>
                    <ellipse cx="71.71" cy="612.01" rx="37.28" ry="5.72" fill="#510fa8" opacity="0.1"></ellipse>
                    <path
                    ...
                    <ellipse cx="645.79" cy="789.35" rx="84.04" ry="13.79" fill="#510fa8" opacity="0.1"></ellipse>
                    <g opacity="0.1">
                        <path
                            ...
                            transform="translate(-61.06 -43.49)"></path>
                        <g opacity="0.2">
                            <rect x="511.08" y="465.45" width="207.7" height="12.66" rx="5.67" ry="5.67"></rect>
                            <rect x="511.08" y="437.16" width="90.06" height="12.66" rx="5.67" ry="5.67"></rect>
                        </g>
                    </g>
                    <path
                        ...
                        transform="translate(-61.06 -43.49)" fill="#fff"></path>
                    <g opacity="0.2">
                        <rect x="508.85" y="463.22" width="207.7" height="12.66" rx="5.67" ry="5.67" fill="#510fa8">
                        </rect>
                        <rect x="508.85" y="434.93" width="90.06" height="12.66" rx="5.67" ry="5.67" fill="#510fa8">
                        </rect>
                    </g>
                    <path
                        ...
                        transform="translate(-61.06 -43.49)" fill="url(#6e777f18-a157-4954-9b1f-a7cbf36b1989-18)">
                    </path>
                    <path
                    ...
                    <path
                        ...
                        transform="translate(-61.06 -43.49)" fill="#575988"></path>
                    <path d="M705.71,692.91l23.73-3.16S716,703.46,705.71,692.91Z" transform="translate(-61.06 -43.49)"
                        opacity="0.05"></path>
                    ...
                    <path d="M676.31,700.58s-15.06,3.42-15.51,9.47S676.31,700.58,676.31,700.58Z"
                        transform="translate(-61.06 -43.49)" opacity="0.1"></path>
                    <path d="M679.62,775.8s-21.28,4-15.24,6.67,16,4.87,16,4.87S687.2,787.7,679.62,775.8Z"
                        transform="translate(-61.06 -43.49)" opacity="0.05"></path>
                    <g opacity="0.05">
                        <path
                    ...
                    <path d="M645.74,513.06c-.17-.21,40.49,51.14,72.06,21.47C717.8,534.53,667.92,541.29,645.74,513.06Z"
                        transform="translate(-61.06 -43.49)" opacity="0.1"></path>
                    <path
                    ...
                    <path d="M621.47,460.42c-.1-.32-3.6,13.86,13.49,21.71C635,482.13,627.7,479.66,621.47,460.42Z"
                        transform="translate(-61.06 -43.49)" opacity="0.1"></path>
                    <path d="M727.72,448.67c-.27,0,8.44,5.54,10.8,8.11C738.52,456.78,732.86,448.31,727.72,448.67Z"
                        transform="translate(-61.06 -43.49)" opacity="0.1"></path>
                    <path
                    ...
                    <path d="M721,438.47s14.89,0,18.17,5.61" transform="translate(-61.06 -43.49)" opacity="0.1"></path>
                    <path
                    ...
                    <div class="col-lg-5 col-xl-6 text-center text-lg-left">
                        ...
                        <div>
                            <h2 class="text-white mb-4">
                                ...
                                <span class="d-block">Purpose <strong class="font-weight-light">Website UI
                                        Kit</strong></span>
                            </h2>
                            <p class="lead text-white">A unique and beautiful collection of UI elements that are all
                                flexible and modular. A complete and customizable solution to building the website of
                                your dreams.</p>
                            <div class="mt-5">
                                <a href="https://preview.webpixels.io/purpose-website-ui-kit/#sct-page-examples"
                                ...
                                <a href="https://preview.webpixels.io/purpose-website-ui-kit/#sct-features"
                                    class="btn btn-outline-white rounded-pill hover-translate-y-n3 btn-icon d-none d-xl-inline-block scroll-me">
    ...
    <section id="sct-page-examples" class="slice bg-section-secondary">
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-6">
                    <div class="card text-center hover-shadow-lg hover-translate-y-n10">
                        <div class="px-4 py-5">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="147px" height="109px" viewBox="0 0 147 109" version="1.1"
                                class="injected-svg svg-inject" style="height: 70px;">
                                ...
                                <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g id="Code_2" transform="translate(1.000000, 1.000000)">
                                        <path
                                            d="M144.1,8.5 L144.1,98.1 C144.1,102.2 140.8,105.6 136.6,105.6 L8.1,105.6 C4,105.6 0.6,102.3 0.6,98.1 L0.6,0.6 L136.1,0.6 C140.6,0.6 144.1,4.2 144.1,8.5 Z"
                                            id="Shape" class="fill-neutral" fill-rule="nonzero"></path>
                                        <path
                                            d="M133.7,0.6 C139.4,0.6 144.1,5.3 144.1,11 L144.1,98.1 C144.1,102.2 140.9,105.6 137,105.6 L14.3,105.6 C10.4,105.6 7.2,102.3 7.2,98.1 L7.2,0.6 L133.7,0.6 Z"
                                            id="Shape" class="fill-primary-300" fill-rule="nonzero"></path>
                                        <path
                                            d="M95.9,19.5 L0.7,19.5 L0.7,8.1 C0.7,4 4,0.6 8.2,0.6 L136.7,0.6 C140.8,0.6 144.2,3.9 144.2,8.1 L144.2,19.5 L119.2,19.5"
                                            id="Shape" class="fill-neutral" fill-rule="nonzero"></path>
                                        <path d="M134.9,19.2 L143,19.2" id="Shape" class="stroke-primary"
                                            stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path>
                                        <path d="M124.4,19.2 L125.4,19.2" id="Shape" class="stroke-primary"
                                            stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path>
                                        <path d="M1.3,19.2 L87.5,19.2" id="Shape" class="stroke-primary"
                                            stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path>
                                        <circle id="Oval" class="fill-primary-300" fill-rule="nonzero" cx="13.5"
                                            cy="10.2" r="3.2"></circle>
                                        <circle id="Oval" class="fill-primary-200" fill-rule="nonzero" cx="24.1"
                                            cy="10.2" r="3.2"></circle>
                                        <circle id="Oval" class="fill-primary-200" fill-rule="nonzero" cx="34.7"
                                            cy="10.2" r="3.2"></circle>
                                        <path d="M0.7,62.6 L0.7,61.4" id="Shape" class="stroke-primary" stroke-width="3"
                                            stroke-linecap="round" stroke-linejoin="round"></path>
                                        <path
                                            d="M0.7,55.2 L0.7,8 C0.7,3.9 4,0.5 8.2,0.5 L136.7,0.5 C140.8,0.5 144.2,3.8 144.2,8 L144.2,98.1 C144.2,102.2 140.9,105.6 136.7,105.6 L8.2,105.6 C4.1,105.6 0.7,102.3 0.7,98.1 L0.7,77"
                                            id="Shape" class="stroke-primary" stroke-width="3" stroke-linecap="round"
                                            stroke-linejoin="round"></path>
                                        <g id="Group" transform="translate(18.000000, 31.000000)" stroke-linecap="round"
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="card text-center hover-shadow-lg hover-translate-y-n10">
                        <div class="px-4 py-5">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="147px" height="110px" viewBox="0 0 147 110" version="1.1"
                                class="injected-svg svg-inject" style="height: 70px;">
                                <!-- Generator: Sketch 51.2 (57519) - http://www.bohemiancoding.com/sketch -->
                                <title>Code</title>
                                <desc>Created with Sketch.</desc>
                                ...
                                <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g id="Code" transform="translate(2.000000, 1.000000)">
                                        <path
                                            d="M137.6,97.2 L21.2,97.2 C18.4,97.2 16.1,94.9 16.1,92.1 L16.1,10.2 C16.1,7.4 18.4,5.1 21.2,5.1 L137.6,5.1 C140.4,5.1 142.7,7.4 142.7,10.2 L142.7,92.1 C142.7,94.9 140.4,97.2 137.6,97.2 Z"
                                            id="Shape" class="fill-primary-200" fill-rule="nonzero"></path>
                                        <path
                                            d="M12.8,5.6 C13.6,2.8 16.2,0.7 19.3,0.7 L136.6,0.7 C140.4,0.7 143.4,3.7 143.4,7.5 L143.4,89.8 C143.4,93.3 140.8,96.2 137.4,96.6"
                                            id="Shape" class="stroke-primary-400" stroke-width="3"
                                            stroke-linecap="round" stroke-linejoin="round"></path>
                                        <path
                                            d="M131.2,18 L131.2,99.9 C131.2,103.7 128.1,106.7 124.4,106.7 L7,106.7 C3.2,106.7 0.2,103.6 0.2,99.9 L0.2,10.8 L124,10.8 C128,10.8 131.2,14 131.2,18 Z"
                                            id="Shape" class="fill-neutral" fill-rule="nonzero"></path>
                                        <path
                                            d="M121.7,10.8 C126.9,10.8 131.2,15.1 131.2,20.3 L131.2,99.9 C131.2,103.7 128.3,106.7 124.7,106.7 L12.6,106.7 C9,106.7 6.1,103.6 6.1,99.9 L6.1,10.8 L121.7,10.8 Z"
                                            id="Shape" class="fill-primary-300" fill-rule="nonzero"></path>
                                        <path
                                            d="M87.2,28 L0.2,28 L0.2,17.6 C0.2,13.8 3.2,10.8 7,10.8 L124.3,10.8 C128.1,10.8 131.1,13.8 131.1,17.6 L131.1,28 L108.2,28"
                                            id="Shape" class="fill-neutral" fill-rule="nonzero"></path>
                                        <path d="M122.8,27.7 L130.2,27.7" id="Shape" class="stroke-primary"
                                            stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path>
                                        <path d="M113.2,27.7 L114.1,27.7" id="Shape" class="stroke-primary"
                                            stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path>
                                        <path d="M0.7,27.7 L79.5,27.7" id="Shape" class="stroke-primary"
                                            stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path>
                                        <circle id="Oval" class="fill-primary-300" fill-rule="nonzero" cx="11.8"
                                            cy="19.5" r="2.9"></circle>
                                        <circle id="Oval" class="fill-primary-200" fill-rule="nonzero" cx="21.5"
                                            cy="19.5" r="2.9"></circle>
                                        <circle id="Oval" class="fill-primary-200" fill-rule="nonzero" cx="31.2"
                                            cy="19.5" r="2.9"></circle>
                                        <polyline id="Shape" class="stroke-primary" stroke-width="3"
                                            stroke-linecap="round" stroke-linejoin="round"
                                            points="47.8 82.9 33.5 65.8 47.8 48.7"></polyline>
                                        <polyline id="Shape" class="stroke-primary" stroke-width="3"
                                            stroke-linecap="round" stroke-linejoin="round"
                                            points="83.9 82.9 98.2 65.8 83.9 48.7"></polyline>
                                        <path d="M72.1,48.3 L59.6,84.1" id="Shape" class="stroke-primary"
                                            stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path>
                                        <path d="M0.2,67.4 L0.2,66.3" id="Shape" class="stroke-primary" stroke-width="3"
                                            stroke-linecap="round" stroke-linejoin="round"></path>
                                        <path
                                            d="M0.2,60.6 L0.2,17.5 C0.2,13.7 3.2,10.7 7,10.7 L124.3,10.7 C128.1,10.7 131.1,13.7 131.1,17.5 L131.1,99.8 C131.1,103.6 128.1,106.6 124.3,106.6 L7,106.6 C3.2,106.6 0.2,103.6 0.2,99.8 L0.2,80.5"
                                            id="Shape" class="stroke-primary" stroke-width="3" stroke-linecap="round"
                                            stroke-linejoin="round"></path>
                                    </g>
                                </g>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="card text-center hover-shadow-lg hover-translate-y-n10">
                        <div class="px-4 py-5">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="131px" height="151px" viewBox="0 0 131 151" version="1.1"
                                class="injected-svg svg-inject" style="height: 70px;">
                                <!-- Generator: Sketch 51.2 (57519) - http://www.bohemiancoding.com/sketch -->
                                ...
                                <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g id="Secure_Files" transform="translate(1.000000, 2.000000)">
                                        <g id="Group" transform="translate(8.000000, 5.000000)">
                                            <path
                                                d="M98.3,24 L119.5,108.9 C120.2,111.8 118.4,114.7 115.5,115.3 L32.7,134.9 C29.8,135.6 26.9,133.8 26.3,130.9 L0.3,21.5 C-0.4,18.6 1.4,15.7 4.3,15.1 L64.3,0.9 L98.3,24 Z"
                                                id="Shape" class="fill-neutral" fill-rule="nonzero"></path>
                                            <path
                                                d="M98.5,24.5 L119.6,109.2 C120.2,111.9 118.6,114.7 115.8,115.3 L37.2,133.9 C34.5,134.5 31.7,132.9 31.1,130.1 L6.1,24.5 C5.5,21.8 7.1,19 9.9,18.4 L69.7,4.2 L98.5,24.5 Z"
                                                id="Shape" class="fill-primary-100" fill-rule="nonzero"></path>
                                            <path d="M64.3,0.9 L69.9,24.4 C70.7,27.6 74.2,29.7 77.4,28.9 L98.3,23.9"
                                                id="Shape" class="fill-neutral" fill-rule="nonzero"></path>
                                            <path d="M67.8,2.6 L72.9,23.9 C73.6,26.8 76.8,28.7 79.7,28 L98.7,23.5"
                                                id="Shape" class="fill-primary-300" fill-rule="nonzero"></path>
                                            <path
                                                d="M68.9,6.9 L74,28.2 C74.7,31.1 77.9,33 80.8,32.3 L99.8,27.8 L98.8,23.5"
                                                id="Shape" class="fill-primary-300" fill-rule="nonzero"></path>
                                            <path d="M68.7,19.2 L69.9,24.3 C70.7,27.5 74.2,29.6 77.4,28.8 L98.3,23.8"
                                                id="Shape" class="stroke-primary" stroke-width="3"
                                                stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M64.3,0.9 L67.3,13.6" id="Shape" class="stroke-primary"
                                                stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path
                                                d="M9.5,60.1 L0.3,21.5 C-0.4,18.6 1.4,15.7 4.3,15.1 L64.3,0.9 L98.3,24 L119.5,108.9 C120.2,111.8 118.4,114.7 115.5,115.3 L32.7,134.9 C29.8,135.6 26.9,133.8 26.3,130.9 L8.8,57.2"
                                                id="Shape" class="stroke-primary" stroke-width="3"
                                                stroke-linecap="round" stroke-linejoin="round"></path>
                                        </g>
                                        <g id="Group">
                                            <path
                                                d="M122.2,62.5 L90.1,143.9 C89,146.6 85.9,148 83.1,146.8 L4.3,114.7 C1.6,113.6 0.2,110.5 1.4,107.7 L43.9,3.5 C45,0.8 48.1,-0.6 50.9,0.6 L108,23.9 L122.2,62.5 Z"
                                                id="Shape" class="fill-neutral" fill-rule="nonzero"></path>
                                            <path
                                                d="M122.1,63 L90.1,144.1 C89,146.7 86.1,147.9 83.5,146.9 L8.7,116.4 C6.1,115.3 4.9,112.4 5.9,109.8 L46.9,9.3 C48,6.7 50.9,5.5 53.5,6.5 L110.4,29.7 L122.1,63 Z"
                                                id="Shape" class="fill-primary-100" fill-rule="nonzero"></path>
                                            <path d="M108,24 L98.9,46.3 C97.6,49.4 99.3,53.1 102.4,54.4 L122.3,62.5"
                                                id="Shape" class="fill-neutral" fill-rule="nonzero"></path>
                                            <path d="M109.9,27.4 L101.6,47.7 C100.5,50.5 102,53.9 104.8,55 L122.9,62.4"
                                                id="Shape" class="fill-primary-300" fill-rule="nonzero"></path>
                                            <path
                                                d="M108.2,31.5 L99.9,51.8 C98.8,54.6 100.3,58 103.1,59.1 L121.2,66.5 L122.9,62.4"
                                                id="Shape" class="fill-primary-300" fill-rule="nonzero"></path>
                                            <path d="M100.9,41.5 L98.9,46.4 C97.6,49.5 99.3,53.2 102.4,54.5 L122.3,62.6"
                                                id="Shape" class="stroke-primary" stroke-width="3"
                                                stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M108,24 L103.1,36.1" id="Shape" class="stroke-primary"
                                                stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M35,25.3 L35.5,24.1" id="Shape" class="stroke-primary"
                                                stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path
                                                d="M37.8,18.4 L43.8,3.6 C44.9,0.9 48,-0.5 50.8,0.7 L107.9,24 L122.1,62.6 L90,144 C88.9,146.7 85.8,148.1 83,146.9 L4.2,114.8 C1.5,113.7 0.1,110.6 1.3,107.8 L29.9,37.6"
                                                id="Shape" class="stroke-primary" stroke-width="3"
                                                stroke-linecap="round" stroke-linejoin="round"></path>
                                        </g>
                                        <g id="Group" transform="translate(18.000000, 10.000000)">
                                            <path
                                                d="M96,118.2 C96,121.2 93.6,123.6 90.6,123.6 L5.5,123.6 C2.5,123.6 0.1,121.2 0.1,118.2 L0.1,5.7 C0.1,2.7 2.5,0.3 5.5,0.3 L67.2,0.3 L94.9,30.6 L95.5,81.4 L96,118.2 Z"
                                                id="Shape" class="fill-neutral" fill-rule="nonzero"></path>
                                            <path
                                                d="M95.6,81.6 L92.8,81.6 C92.8,76.2 93.3,71.2 89.6,65.1 C89.6,65.1 89.6,65.1 89.6,65.1 C89.5,64.9 87.5,62 87.3,62 C80.9,54.7 70.5,52.5 61.7,56.4 L55.1,61 C51.1,65 48.6,70.5 48.6,76.6 L48.6,81.7 L44.4,81.7 C42.5,81.7 40.9,83.2 40.9,85.2 L40.9,123.8 L90.6,123.8 C93.6,123.8 96,121.4 96,118.4 L95.6,81.6 Z M86.8,81.6 L54.7,81.6 L54.7,76.5 C54.7,62.6 71.5,54.8 82.1,65.2 C87.5,70.5 86.8,76.5 86.8,81.6 Z"
                                                id="Shape" class="fill-primary-100" fill-rule="nonzero"></path>
                                            <path d="M29.2,89.9 L80.3,89.9" id="Shape" class="stroke-primary-300"
                                                stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M14,89.9 L23,89.9" id="Shape" class="stroke-primary-300"
                                                stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M57.3,76.1 L80.1,76.1" id="Shape" class="stroke-primary-300"
                                                stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M14.5,76.1 L47.7,76.1" id="Shape" class="stroke-primary-300"
                                                stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M71.7,62.3 L80.6,62.3" id="Shape" class="stroke-primary-300"
                                                stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M14.9,62.3 L63.6,62.3" id="Shape" class="stroke-primary-300"
                                                stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M38.6,104.9 L41.6,104.9" id="Shape" class="stroke-primary-300"
                                                stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M14.9,104.9 L33,104.9" id="Shape" class="stroke-primary-300"
                                                stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M49.6,48.6 L81,48.6" id="Shape" class="stroke-primary-300"
                                                stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M15.3,48.6 L39.6,48.6" id="Shape" class="stroke-primary-300"
                                                stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M15.8,17.1 L56.6,17.1" id="Shape" class="stroke-primary"
                                                stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M15.8,26.8 L31.4,26.8" id="Shape" class="stroke-primary"
                                                stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M67.3,0.5 L67.3,24.6 C67.3,27.9 70.2,30.8 73.6,30.8 L95.1,30.8"
                                                id="Shape" class="fill-neutral" fill-rule="nonzero"></path>
                                            <path d="M70.3,2.9 L70.3,24.8 C70.3,27.8 73,30.4 76,30.4 L95.5,30.4"
                                                id="Shape" class="fill-primary-300" fill-rule="nonzero"></path>
                                            <path
                                                d="M70.3,7.3 L70.3,29.2 C70.3,32.2 73,34.8 76,34.8 L95.5,34.8 L95.5,30.4"
                                                id="Shape" class="fill-primary-300" fill-rule="nonzero"></path>
                                            <path d="M67.3,19.3 L67.3,24.6 C67.3,27.9 70.2,30.8 73.6,30.8 L95.1,30.8"
                                                id="Shape" class="stroke-primary" stroke-width="3"
                                                stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M67.3,0.5 L67.3,13.5" id="Shape" class="stroke-primary"
                                                stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M0.2,29.2 L0.2,27.9" id="Shape" class="stroke-primary"
                                                stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path
                                                d="M0.2,21.7 L0.2,5.7 C0.2,2.7 2.6,0.3 5.6,0.3 L67.3,0.3 L95,30.6 L96,118.1 C96,121.1 93.6,123.5 90.6,123.5 L5.5,123.5 C2.5,123.5 0.1,121.1 0.1,118.1 L0.1,42.3"
                                                id="Shape" class="stroke-primary" stroke-width="3"
                                                stroke-linecap="round" stroke-linejoin="round"></path>
                                        </g>
                                        <g id="Group" transform="translate(66.000000, 60.000000)">
                                            <path
                                                d="M46.5,8.3 C42.6,4.9 37.5,2.8 32,2.8 C19.8,2.8 9.9,12.7 9.9,24.9 L9.9,28 L13.9,28 L13.9,22.9 C13.9,14.1 21.1,6.9 29.9,6.9 C34.9,6.9 39.3,9.2 42.2,12.7 C44.5,15.5 45.9,19.1 45.9,23 L45.9,28.1 L52,28.1 L52,23 C51.9,17.3 49.9,12.2 46.5,8.3 Z"
                                                id="Shape" class="fill-primary-400" fill-rule="nonzero"></path>
                                            <path
                                                d="M55.8,78.9 L3.6,78.9 C1.6,78.9 4.54747351e-13,77.3 4.54747351e-13,75.3 L4.54747351e-13,31.6 C4.54747351e-13,29.6 1.6,28 3.6,28 L55.8,28 C57.8,28 59.4,29.6 59.4,31.6 L59.4,75.3 C59.4,77.3 57.8,78.9 55.8,78.9 Z"
                                                id="Shape" class="fill-neutral" fill-rule="nonzero"></path>
                                            <path
                                                d="M59.4,33.7 L59.4,75.7 C59.4,77.5 58,78.9 56.2,78.9 L8,78.9 C6.2,78.9 4.8,77.5 4.8,75.7 L4.8,33.7 C4.8,31.9 6.2,30.5 8,30.5 L56.2,30.5 C56.5,30.5 56.7,30.5 57,30.6 C58.4,30.9 59.4,32.2 59.4,33.7 Z"
                                                id="Shape" class="fill-primary-500" fill-rule="nonzero"></path>
                                            <path
                                                d="M57,30.6 L57,69 C57,70.8 55.6,72.2 53.8,72.2 L5.6,72.2 C5.3,72.2 5,72.2 4.8,72.1 L4.8,33.7 C4.8,31.9 6.2,30.5 8,30.5 L56.2,30.5 C56.5,30.5 56.7,30.5 57,30.6 Z"
                                                id="Shape" class="fill-primary-300" fill-rule="nonzero"></path>
                                            <path d="M0.1,43.1 L0.1,42.2" id="Shape" class="stroke-primary"
                                                stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path
                                                d="M59.4,75.6 C59.3,77.4 57.8,78.8 56,78.8 L3.6,78.8 C1.7,78.8 0.2,77.3 0.2,75.4 L0.2,50.1"
                                                id="Shape" class="stroke-primary" stroke-width="3"
                                                stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M59.4,54.6 L59.4,71.1" id="Shape" class="stroke-primary"
                                                stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path
                                                d="M0.1,38.9 L0.1,31.4 C0.1,29.5 1.6,28 3.5,28 L55.9,28 C57.8,28 59.3,29.5 59.3,31.4 L59.3,44.1"
                                                id="Shape" class="stroke-primary" stroke-width="3"
                                                stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path
                                                d="M24.3,49 C24.2,51.8 25,53.7 27.6,54.4 L27.6,61.8 C27.6,62.7 28.3,63.5 29.3,63.5 C30.2,63.5 32,62.8 32,61.8 L32,55 C34.5,54.3 36.4,51.9 36.4,49.2 C36.4,45.6 33.3,42.8 29.6,43.2 C26.8,43.5 24.6,45.8 24.3,48.6 C24.3,48.6 24.3,48.8 24.3,49"
                                                id="Shape" class="fill-primary-600" fill-rule="nonzero"></path>
                                            <path
                                                d="M27.9,61.3 L27.9,61.7 C27.9,62.7 28.7,63.5 29.7,63.5 C30.7,63.5 31.5,62.7 31.5,61.7 L31.5,54.2 C34.3,53.4 36.3,50.8 36.3,47.8 C36.3,43.9 32.9,40.7 28.9,41.2 C25.8,41.5 23.4,44 23,47.1 C23,47.4 23,47.6 23,47.9"
                                                id="Shape" class="stroke-primary" stroke-width="3"
                                                stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M24.2,51.3 C25.1,52.6 26.4,53.6 28,54.1 L28,56.7" id="Shape"
                                                class="stroke-primary" stroke-width="3" stroke-linecap="round"
                                                stroke-linejoin="round"></path>
                                            <path
                                                d="M16.6,5.2 C16.5,5.3 16.4,5.4 16.3,5.4 M14.3,7.3 C10.3,11.3 7.8,16.8 7.8,22.9 L7.8,28 L13.9,28 L13.9,22.9 C13.9,14.1 21.1,6.9 29.9,6.9 C38.7,6.9 45.9,14.1 45.9,22.9 L45.9,28 L52,28 L52,22.9 C52,10.7 42.1,0.8 29.9,0.8 C26.7,0.8 23.7,1.5 20.9,2.7"
                                                id="Shape" class="stroke-primary" stroke-width="3"
                                                stroke-linecap="round" stroke-linejoin="round"></path>
                                        </g>
                                    </g>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="card text-center hover-shadow-lg hover-translate-y-n10">
                        <div class="px-4 py-5">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="148px" height="144px" viewBox="0 0 148 144" version="1.1"
                                class="injected-svg svg-inject" style="height: 70px;">
                                <!-- Generator: Sketch 51.2 (57519) - http://www.bohemiancoding.com/sketch -->
                                <title>Task</title>
                                <desc>Created with Sketch.</desc>
                                ...
                                <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g id="Task" transform="translate(2.000000, 2.000000)">
                                        <g id="Group" transform="translate(0.000000, 137.000000)"
                                            class="stroke-primary-300" stroke-linecap="round" stroke-linejoin="round"
                                            stroke-width="3">
                                        ...
                                        <path
                                            d="M22.5,8.7 L102.5,8.7 C104.5,8.7 106.1,10.3 106.1,12.3 L106.1,133.3 C106.1,135.3 104.5,136.9 102.5,136.9 L10.8,136.9 C8.8,136.9 7.2,135.3 7.2,133.3 L7.2,12.3 C7.2,10.3 8.8,8.7 10.8,8.7 L16.1,8.7"
                                            id="Shape" class="fill-neutral" fill-rule="nonzero"></path>
                                        <path d="M16,8.7 L17.5,8.7" id="Shape" class="fill-neutral" fill-rule="nonzero">
                                        </path>
                                        <path
                                            d="M106.1,17.7 L106.1,133.3 C106.1,135.3 104.5,136.9 102.5,136.9 L14.9,136.9 C12.9,136.9 11.3,135.3 11.3,133.3 L11.3,17.7 C11.3,15.7 12.9,14.1 14.9,14.1 L102.5,14.1 C104.5,14.1 106.1,15.7 106.1,17.7 Z"
                                            id="Shape" class="fill-primary-300" fill-rule="nonzero"></path>
                                        <path
                                            d="M99.9,25.4 L99.9,128.5 C99.9,130 98.7,131.2 97.2,131.2 L19.6,131.2 C18.1,131.2 16.9,130 16.9,128.5 L16.9,25.4 C16.9,23.9 18.1,22.7 19.6,22.7 L97.2,22.7 C98.7,22.7 99.9,23.9 99.9,25.4 Z"
                                            id="Shape" class="fill-neutral" fill-rule="nonzero"></path>
                                        <path
                                            d="M108.1,75.6 L108.1,128 C108.1,129.7 106.7,131.2 104.9,131.2 L81.6,131.2 C75.6,125.3 71.9,117.1 71.9,108 C71.9,90 86.5,75.4 104.5,75.4 C105.7,75.4 106.9,75.5 108.1,75.6 Z"
                                            id="Shape" class="fill-primary-400" fill-rule="nonzero"></path>
                                        <path d="M7.2,93.7 L7.2,12.3 C7.2,10.3 8.8,8.7 10.8,8.7 L12.9,8.7" id="Shape"
                                            class="stroke-primary" stroke-width="3" stroke-linecap="round"
                                            stroke-linejoin="round"></path>
                                        <path
                                            d="M24.6,8.7 L102.5,8.7 C104.5,8.7 106.1,10.3 106.1,12.3 L106.1,133.3 C106.1,135.3 104.5,136.9 102.5,136.9 L10.8,136.9 C8.8,136.9 7.2,135.3 7.2,133.3 L7.2,112.7"
                                            id="Shape" class="stroke-primary" stroke-width="3" stroke-linecap="round"
                                            stroke-linejoin="round"></path>
                                        <path d="M19,8.7 L19.2,8.7" id="Shape" class="stroke-primary" stroke-width="3"
                                            stroke-linecap="round" stroke-linejoin="round"></path>
                                        <path
                                            d="M85.3,10.3 C85.3,12 84.6,13.5 83.6,14.5 C82.5,15.6 81,16.3 79.4,16.3 L34,16.3 C30.7,16.3 28,13.6 28,10.3 C28,9.4 28.2,8.6 28.5,7.9 C28.8,7.2 29.2,6.6 29.8,6.1 C30.9,5 32.4,4.4 34,4.4 L53.9,4.4 C53.8,4.7 53.7,5.1 53.7,5.4 C53.7,7.1 55,8.4 56.7,8.4 C58.4,8.4 59.7,7.1 59.7,5.4 C59.7,5 59.6,4.7 59.5,4.4 L79.4,4.4 C81.9,4.4 84,5.9 84.9,8 C85.1,8.6 85.3,9.4 85.3,10.3 Z"
                                            id="Shape" class="fill-neutral" fill-rule="nonzero"></path>
                                        <path
                                            d="M79.7,7.3 C82,7.3 84,8.4 84.8,10 C85.1,10.5 85.3,11.1 85.3,11.8 C85.3,13 84.7,14.1 83.7,15 C82.7,15.8 81.3,16.3 79.7,16.3 L37.2,16.3 C34.1,16.3 31.6,14.3 31.6,11.8 C31.6,11.2 31.8,10.6 32.1,10 C32.4,9.5 32.8,9 33.3,8.6 C34.3,7.8 35.7,7.3 37.3,7.3 L79.7,7.3 Z"
                                            id="Shape" class="fill-primary-100" fill-rule="nonzero"></path>
                                        <g id="Group" transform="translate(27.000000, 0.000000)" class="stroke-primary"
                                            stroke-linecap="round" stroke-linejoin="round" stroke-width="3">
                                            <path
                                                d="M8.4,16.2 L6.9,16.2 C3.6,16.2 0.9,13.5 0.9,10.2 C0.9,9.3 1.1,8.5 1.4,7.8 C1.7,7.1 2.1,6.5 2.7,6 C3.8,4.9 5.3,4.3 6.9,4.3 L19.1,4.3"
                                                id="Shape"></path>
                                            <path d="M37.3,16.2 L14.7,16.2" id="Shape"></path>
                                            <path
                                                d="M25.3,4.3 L26.9,4.3 C26.8,4.6 26.7,5 26.7,5.3 C26.7,7 28,8.3 29.7,8.3 C31.4,8.3 32.7,7 32.7,5.3 C32.7,4.9 32.6,4.6 32.5,4.3 L52.4,4.3 C54.9,4.3 57,5.8 57.9,7.9 C58.2,8.6 58.4,9.4 58.4,10.3 C58.4,12 57.7,13.5 56.7,14.5 C55.8,15.4 54.6,16 53.2,16.2"
                                                id="Shape"></path>
                                            <path
                                                d="M29.5,0.4 C29.6,0.4 29.6,0.4 29.7,0.4 C32.2,0.4 34.2,2.4 34.2,4.9 C34.2,7.4 32.2,9.4 29.7,9.4 C27.2,9.4 25.2,7.4 25.2,4.9 C25.2,4 25.4,3.2 25.9,2.6"
                                                id="Shape" class="fill-neutral" fill-rule="nonzero"></path>
                                        </g>
                                        <g id="Group" transform="translate(26.000000, 41.000000)" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-width="3">
                                        ...
                                        <g id="Group" transform="translate(26.000000, 61.000000)" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-width="3">
                                        ...
                                        <g id="Group" transform="translate(26.000000, 82.000000)" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-width="3">
                                        ...
                                        <g id="Group" transform="translate(26.000000, 102.000000)"
                                            stroke-linecap="round" stroke-linejoin="round" stroke-width="3">
                                            <path d="M50.9,0.7 L62.2,0.7" id="Shape" class="stroke-primary-300"></path>
                                        ...
                                        <circle id="Oval" stroke-width="3" class="fill-primary-400 stroke-primary-400"
                                            fill-rule="nonzero" cx="111.7" cy="107.4" r="32.7"></circle>
                                        <path
                                            d="M101.3,138.4 C88.3,134.1 79,121.8 79,107.4 C79,89.3 93.7,74.7 111.7,74.7 C113.5,74.7 115.2,74.8 116.9,75.1"
                                            id="Shape" class="stroke-primary" stroke-width="3" stroke-linecap="round"
                                            stroke-linejoin="round"></path>
                                        <path
                                            d="M140.1,91.1 C142.8,95.9 144.4,101.4 144.4,107.3 C144.4,125.4 129.7,140 111.7,140 C111.5,140 111.2,140 111,140"
                                            id="Shape" class="stroke-primary" stroke-width="3" stroke-linecap="round"
                                            stroke-linejoin="round"></path>
                                        <path d="M125.6,77.7 C127.5,78.6 129.2,79.6 130.9,80.8" id="Shape"
                                            class="stroke-primary" stroke-width="3" stroke-linecap="round"
                                            stroke-linejoin="round"></path>
                                        <path
                                            d="M108.6,120.2 C107.4,120.2 106.3,119.7 105.5,118.9 L96.3,109.7 C94.6,108 94.6,105.2 96.3,103.5 C98,101.8 100.8,101.8 102.5,103.5 L108.6,109.6 L122.4,95.8 C124.1,94.1 126.9,94.1 128.6,95.8 C130.3,97.5 130.3,100.3 128.6,102 L111.7,118.9 C110.9,119.8 109.7,120.2 108.6,120.2 Z"
                                            id="Shape" stroke-width="3" class="stroke-primary fill-neutral"
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="card text-center hover-shadow-lg hover-translate-y-n10">
                        <div class="px-4 py-5">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="153px" height="132px" viewBox="0 0 153 132" version="1.1"
                                class="injected-svg svg-inject" style="height: 70px;">
                                <!-- Generator: Sketch 51.2 (57519) - http://www.bohemiancoding.com/sketch -->
                                ...
                                <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g id="Cart_Add_2" transform="translate(2.000000, 2.000000)">
                                        <g id="Group" transform="translate(16.000000, 127.000000)"
                                            class="stroke-primary-300" stroke-linecap="round" stroke-linejoin="round"
                                            stroke-width="3">
                                        ...
                                        <path
                                            d="M133,34 C131.3,31.6 128.6,30.3 125.7,30.3 C125.7,30.3 125.7,30.3 125.6,30.3 L46,30.3 C43.4,30.3 41.3,32.4 41.3,35 C41.3,37.6 43.4,39.7 46,39.7 L125.4,39.7 L115.8,70.7 C115.1,72.9 113.1,74.3 110.9,74.3 L44.9,74.3 L25.9,11.6 C24.6,7.4 20.8,4.5 16.3,4.5 L4.8,4.5 C2.2,4.5 0.1,6.6 0.1,9.2 C0.1,11.8 2.2,13.9 4.8,13.9 L16.3,13.9 C16.6,13.9 16.9,14.1 17,14.4 L40,90.1 C41.8,95.9 47.2,99.8 53.2,99.8 L111.3,99.8 C113.9,99.8 116,97.7 116,95.1 C116,92.5 113.9,90.4 111.3,90.4 L53.2,90.4 C51.2,90.4 49.4,89.1 48.8,87.2 L47.7,83.6 L110.9,83.6 C117.3,83.6 122.8,79.5 124.7,73.4 L134.3,42.3 C135.3,39.4 134.8,36.4 133,34 Z"
                                            id="Shape" class="fill-neutral" fill-rule="nonzero"></path>
                                        <path
                                            d="M134.6,41.3 C134.5,41.6 134.5,41.9 134.4,42.2 L124.8,73.3 C122.9,79.4 117.4,83.5 111,83.5 L47.9,83.5 L50.9,90.8 C51.5,92.7 53.2,94 55.3,94 L111.6,94 C113.5,94 115.1,95.1 115.9,96.8 C115.2,98.4 113.5,99.6 111.6,99.6 L53.5,99.6 C47.4,99.6 42.1,95.7 40.2,89.9 L17.2,14.2 C17.1,13.9 16.8,13.7 16.5,13.7 L5,13.7 C3.1,13.7 1.5,12.6 0.7,10.9 C1.4,9.3 3.1,8.1 5,8.1 L16.5,8.1 C20.9,8.1 24.8,11 26.1,15.2 L45.1,74.2 L111.1,74.2 C113.4,74.2 115.4,72.7 116,70.6 L125.6,43.4 L124.4,43.4 L125.6,39.7 L46.2,39.7 C44.3,39.7 42.6,38.6 41.9,36.9 C42.6,35.3 44.2,34.1 46.2,34.1 L125.9,34.1 C128.8,34.1 131.5,35.5 133.2,37.8 C133.8,38.9 134.4,40.1 134.6,41.3 Z"
                                            id="Shape" class="fill-primary-200" fill-rule="nonzero"></path>
                                        <path
                                            d="M119.5,39.6 L125.5,39.6 L115.9,70.6 C115.2,72.8 113.2,74.2 111,74.2 L45,74.2 L26,11.5 C24.7,7.3 20.9,4.4 16.4,4.4 L4.9,4.4 C2.3,4.4 0.2,6.5 0.2,9.1 C0.2,11.7 2.3,13.8 4.9,13.8 L16.4,13.8 C16.7,13.8 17,14 17.1,14.3 L40.1,90 C41.9,95.8 47.3,99.7 53.3,99.7 L111.4,99.7 C114,99.7 116.1,97.6 116.1,95 C116.1,92.4 114,90.3 111.4,90.3 L53.3,90.3 C51.3,90.3 49.5,89 48.9,87.1 L47.8,83.5 L111,83.5 C117.4,83.5 122.9,79.4 124.8,73.3 L134.4,42.2 C135.3,39.4 134.8,36.4 133,34 C131.3,31.6 128.6,30.3 125.7,30.3 C125.7,30.3 125.7,30.3 125.6,30.3 L121,30.3"
                                            id="Shape" class="stroke-primary" stroke-width="3" stroke-linecap="round"
                                            stroke-linejoin="round"></path>
                                        <path
                                            d="M47.3,30.3 L46.1,30.3 C43.5,30.3 41.4,32.4 41.4,35 C41.4,37.6 43.5,39.7 46.1,39.7 L48.8,39.7"
                                            id="Shape" class="stroke-primary" stroke-width="3" stroke-linecap="round"
                                            stroke-linejoin="round"></path>
                                        <circle id="Oval" stroke-width="3" class="stroke-primary fill-primary-400"
                                            fill-rule="nonzero" stroke-linecap="round" stroke-linejoin="round" cx="55.4"
                                            cy="117.3" r="10.3"></circle>
                                        <circle id="Oval" stroke-width="3" class="stroke-primary fill-primary-100"
                                            fill-rule="nonzero" stroke-linecap="round" stroke-linejoin="round" cx="55.4"
                                            cy="117.3" r="4.9"></circle>
                                        <circle id="Oval" stroke-width="3" class="stroke-primary fill-primary-400"
                                            fill-rule="nonzero" stroke-linecap="round" stroke-linejoin="round"
                                            cx="104.8" cy="117.3" r="10.3"></circle>
                                        <circle id="Oval" stroke-width="3" class="stroke-primary fill-primary-100"
                                            fill-rule="nonzero" stroke-linecap="round" stroke-linejoin="round"
                                            cx="104.8" cy="117.3" r="4.9"></circle>
                                        <g id="Group" transform="translate(53.000000, 0.000000)">
                                            <path
                                                d="M47.3,54.8 C42.6,57.9 37,59.7 31,59.7 C14.5,59.7 1.2,46.4 1.2,29.9 C1.2,13.4 14.5,0.1 31,0.1 C47.5,0.1 60.8,13.4 60.8,29.9 C60.7,40.3 55.4,49.5 47.3,54.8"
                                                id="Shape" class="fill-primary-500" fill-rule="nonzero"></path>
                                            <path
                                                d="M40.1,58.5 C39.8,58.6 39.6,58.6 39.3,58.7 C36.6,59.5 33.7,60 30.7,60 C24.1,60 17.9,57.8 13,54.2"
                                                id="Shape" class="stroke-primary" stroke-width="3"
                                                stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path
                                                d="M1.2,34.6 C1,33.2 0.9,31.7 0.9,30.2 C0.9,13.7 14.2,0.4 30.7,0.4 C47.2,0.4 60.5,13.7 60.5,30.2 C60.5,39.4 56.3,47.7 49.7,53.2"
                                                id="Shape" class="stroke-primary" stroke-width="3"
                                                stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M6.2,47.2 C5.9,46.7 5.5,46.2 5.2,45.7" id="Shape"
                                                class="stroke-primary" stroke-width="3" stroke-linecap="round"
                                                stroke-linejoin="round"></path>
                                            <g transform="translate(13.000000, 12.000000)" fill-rule="nonzero"
                                                id="Shape">
                                                <path
                                                    d="M17.9,33.7 C15.9,33.7 13.7,32.2 13.7,29.5 L13.7,22.1 L6.3,22.1 C3.6,22.1 2.1,19.9 2.1,17.9 C2.1,16.8 2.5,15.8 3.1,15 C3.9,14.1 5,13.6 6.2,13.6 L13.6,13.6 L13.6,6.2 C13.6,3.5 15.8,2 17.8,2 C19.8,2 22,3.5 22,6.2 L22,13.6 L29.4,13.6 C30.7,13.6 31.8,14.1 32.5,15 C33.2,15.8 33.5,16.8 33.5,17.9 C33.5,19.9 32,22.1 29.3,22.1 L21.9,22.1 L21.9,29.5 C22.2,32.3 20,33.7 17.9,33.7 Z"
                                                    class="fill-neutral"></path>
                                                <path
                                                    d="M17.9,3.5 C19.3,3.5 20.6,4.4 20.6,6.2 C20.6,8.1 20.6,11.5 20.6,15.1 C24.2,15.1 27.6,15.1 29.5,15.1 C33.1,15.1 33.1,20.5 29.5,20.5 C27.6,20.5 24.2,20.5 20.6,20.5 C20.6,24.1 20.6,27.5 20.6,29.4 C20.6,31.2 19.2,32.1 17.9,32.1 C16.5,32.1 15.2,31.2 15.2,29.4 C15.2,27.5 15.2,24.1 15.2,20.5 C11.6,20.5 8.2,20.5 6.3,20.5 C2.7,20.5 2.7,15.1 6.3,15.1 C8.2,15.1 11.6,15.1 15.2,15.1 C15.2,11.5 15.2,8.1 15.2,6.2 C15.2,4.4 16.6,3.5 17.9,3.5 Z M17.9,0.5 C16.5,0.5 15.1,1 14,1.9 C12.8,3 12.1,4.5 12.1,6.2 L12.1,12.1 L6.2,12.1 C3,12.1 0.5,14.6 0.5,17.8 C0.5,19.2 1,20.6 1.9,21.7 C3,22.9 4.5,23.6 6.2,23.6 L12.1,23.6 L12.1,29.5 C12.1,32.7 14.6,35.2 17.8,35.2 C21.1,35.2 23.5,32.8 23.5,29.5 L23.5,23.6 L29.4,23.6 C32.6,23.6 35.1,21.1 35.1,17.9 C35.1,14.6 32.7,12.2 29.4,12.2 L23.5,12.2 L23.5,6.3 C23.7,3 21.2,0.5 17.9,0.5 Z"
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="card text-center hover-shadow-lg hover-translate-y-n10">
                        <div class="px-4 py-5">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="150px" height="151px" viewBox="0 0 150 151" version="1.1"
                                class="injected-svg svg-inject" style="height: 70px;">
                                <!-- Generator: Sketch 51.2 (57519) - http://www.bohemiancoding.com/sketch -->
        ...
        <div class="fluid-paragraph text-center mt-5">
            <p>
                <strong class="text-primary">*Good to know!</strong> You are not limited to the examples we've built. We
                have the liberty to choose any of the page layouts and components from the package and create your own
                version.
            </p>
        </div>
        <!-- Features (v2) -->
                ...
                <div class="row row-grid justify-content-around align-items-center">
                    <div class="col-lg-5 order-lg-2">
                        <div class=" pr-lg-4">
                            ...
                            <p class="lead mt-4 mb-5">With Purpose you get components and examples, including tons of
                                variables that will help you customize this theme with ease.</p><a
                                href="https://preview.webpixels.io/purpose-website-ui-kit/https://themes.getbootstrap.com/product/purpose-website-ui-kit/"
                                class="link link-underline-primary">Purchase now</a>
                        </div>
                    </div>
                    <div class="col-lg-6 order-lg-1">
                        <img alt="Image placeholder"
                            src="https://preview.webpixels.io/purpose-website-ui-kit/assets/img/theme/light/presentation-1.png"
                ...
                <div class="row row-grid justify-content-around align-items-center">
                    <div class="col-lg-5">
                        <div class="">
                            ...
                            <p class="lead my-4">With Purpose you get components and examples, including tons of
                                variables that will help you customize this theme with ease.</p>
                    ...
                    <div class="col-lg-6">
                        <img alt="Image placeholder"
                            src="https://preview.webpixels.io/purpose-website-ui-kit/assets/img/theme/light/presentation-2.png"
                            class="img-fluid img-center">
                    </div>
                </div>
            </div>
        ...
        <section class="slice slice-lg bg-section-secondary overflow-hidden">
            <div class="bg-absolute-cover bg-size--contain d-flex align-items-center">
                <figure class="w-100">
                    <img alt="Image placeholder"
                        src="https://preview.webpixels.io/purpose-website-ui-kit/assets/img/svg/backgrounds/bg-2.svg"
            ...
            <div class="container position-relative zindex-100">
                <div class="mb-5 px-3 text-center">
                    ...
                    <div class="fluid-paragraph mt-3">
                        <p class="lead lh-180">We use the latest technologies and tools in order to create a better code
                            that not only works great, but it is easy easy to work with too.</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card px-3">
                            <div class="card-body py-5">
                                <div class="d-flex align-items-center">
                                    <div
                                        class="icon bg-gradient-primary text-white rounded-circle icon-shape shadow-primary">
                                ...
                                <p class="mt-4 mb-0">We use the latest technologies and tools in order to create a
                                    better code that not only works great, but it is easy easy to work with too.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="card px-3">
                            <div class="card-body py-5">
                                ...
                                <p class="mt-4 mb-0">You don't only need a theme, but also great tools in order to ease
                                    the process or building and customizing. And this is exactly what we offer you.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="card px-3">
                            <div class="card-body py-5">
                                ...
                                <p class="mt-4 mb-0">is lighter and faster than most of the themes out there which means
                                    you get more for less. Check out the components and examples pages.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="slice slice-xl has-floating-items bg-gradient-primary" id=sct-call-to-action><a
                href="https://preview.webpixels.io/purpose-website-ui-kit/#sct-call-to-action"
                        ...
                        <div class="row justify-content-center mt-4">
                            <div class="col-lg-8">
                                <p class="lead text-white">
                                    Purpose is a great premium UI package including all the important and needed
                                    features so you can jumpstart the hard work and get right to the website creation
                                    fast and easy with more than 100 customized Bootstrap components and 15+ integrated
                                    plugins.
                                </p>
                                <div class="btn-container mt-5">
                                    <a href="https://preview.webpixels.io/purpose-website-ui-kit/https://themes.getbootstrap.com/product/purpose-website-ui-kit/"
                                        class="btn btn-dark rounded-pill btn-icon hover-translate-y-n3 mb-4 mb-md-0">
                                    ...
                                    <a href="https://preview.webpixels.io/purpose-website-ui-kit/docs/index.html"
                                        class="btn btn-white rounded-pill btn-icon hover-translate-y-n3">
                                        <span class="btn-inner--icon">
            ...
            <div class="container floating-items">
                ...
                <div class="icon-floating icon-lg bg-white floating">
                    <span></span>
                    <img alt="Image placeholder"
                        src="https://preview.webpixels.io/purpose-website-ui-kit/assets/img/icons/essential/detailed/Apple.svg"
                        class="svg-inject">
                </div>
                <div class="icon-floating icon-sm bg-white floating">
                    <span></span>
                    <img alt="Image placeholder"
                        src="https://preview.webpixels.io/purpose-website-ui-kit/assets/img/icons/essential/detailed/Ballance.svg"
                        class="svg-inject">
                </div>
                <div class="icon-floating icon-lg bg-white floating">
                    <span></span>
                    <img alt="Image placeholder"
                        src="https://preview.webpixels.io/purpose-website-ui-kit/assets/img/icons/essential/detailed/Book.svg"
                        class="svg-inject">
                </div>
                <div class="icon-floating bg-white floating">
                    <span></span>
                    <img alt="Image placeholder"
                        src="https://preview.webpixels.io/purpose-website-ui-kit/assets/img/icons/essential/detailed/Chat.svg"
                        class="svg-inject">
                </div>
                <div class="icon-floating icon-sm bg-white floating">
                    <span></span>
                    <img alt="Image placeholder"
                        src="https://preview.webpixels.io/purpose-website-ui-kit/assets/img/icons/essential/detailed/Coffee.svg"
                        class="svg-inject">
                </div>
            </div>
        </section>
        ...
        <section class="slice slice-lg bg-section-secondary">
            <div class="container">
                <div class="mb-5 text-center">
                    ...
                    <div class="fluid-paragraph mt-3">
                        <p class="lead lh-180">Start building fast, beautiful and modern looking websites in no time
                            using our theme.</p>
                    </div>
                </div>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <img alt="Image placeholder"
                                                            src="https://preview.webpixels.io/purpose-website-ui-kit/assets/img/theme/light/team-1-800x800.jpg"
                                                ...
                                                <p class="mt-4 lh-180">Amazing template! All-in-one, clean code,
                                                    beautiful design, and really not hard to work with.Highly
                                                    recommended for any kind on website.</p>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <img alt="Image placeholder"
                                                            src="https://preview.webpixels.io/purpose-website-ui-kit/assets/img/theme/light/team-2-800x800.jpg"
                                                            class="avatar  rounded-circle">
                                                    </div>
                                                    <div class="pl-3">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <img alt="Image placeholder"
                                                            src="https://preview.webpixels.io/purpose-website-ui-kit/assets/img/theme/light/team-3-800x800.jpg"
                                                            class="avatar  rounded-circle">
                                                    </div>
                                                    <div class="pl-3">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <img alt="Image placeholder"
                                                            src="https://preview.webpixels.io/purpose-website-ui-kit/assets/img/theme/light/team-4-800x800.jpg"
                                                            class="avatar  rounded-circle">
                                                    </div>
                                                    <div class="pl-3">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <img alt="Image placeholder"
                                                            src="https://preview.webpixels.io/purpose-website-ui-kit/assets/img/theme/light/team-5-800x800.jpg"
                                                            class="avatar  rounded-circle">
                                                    </div>
                                                    <div class="pl-3">
                ...
                <div class="mb-5 text-center">
                    ...
                    <div class="fluid-paragraph mt-3">
                        <p class="lead lh-180">You get all Bootstrap components fully customized. Besides, you receive
                            another numerous plugins out of the box and ready to use.</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <div class="mb-4">
                            ...
                            <p class=" mt-2 mb-0">A responsive and mobile-first theme built with the world's most
                                popular component library.</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6">
                        <div class="mb-4">
                            ...
                            <p class=" mt-2 mb-0">Change one variable and the theme adapts. Colors, fonts, sizes ... you
                                name it.</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6">
                        <div class="mb-4">
                            ...
                            <p class=" mt-2 mb-0">Nicely customized components that can be reused anytime and anywhere
                                in your project.</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6">
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <div class="mb-4">
                            ...
                            <p class=" mt-2 mb-0">A beautiful color palette that can be easily modified with our nicely
                                coded Sass files.</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6">
                        <div class="mb-4">
                            ...
                            <p class=" mt-2 mb-0">More functionality with the ready to use plugins we have integrated in
                                this theme for you.</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6">
                        <div class="mb-4">
                            ...
                            <p class=" mt-2 mb-0">One nice collection of icons so you can add a more intuitive and
                                playful touch to your website.</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6">
                        <div class="mb-4">
                            ...
                            <div class="card-body py-5">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="icon-text">
                                        ...
                                        <p class="text-white mb-0">You get 70+ pre-built pages for a variety of purposes
                                            that makes it the ideal point to start building websites of any kind.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body py-5">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="icon-text">
                                        ...
                                        <p class="mb-0 text-white">Use our dedicated support email to send your issues
                                            or suggestions. We are here to help anytime:
                                            <strong>support@webpixels.io</strong></p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row pt-md">
                <div class="col-lg-4 mb-5 mb-lg-0">
                    <a href="https://preview.webpixels.io/purpose-website-ui-kit/index.html">
                        <img src="https://preview.webpixels.io/purpose-website-ui-kit/assets/img/brand/white.png"
                            alt="Footer logo" style="height: 70px;">
                    </a>
                    <p>Purpose is a unique and beautiful collection of UI elements that are all flexible and modular. A
            ...
            <div class="row align-items-center justify-content-md-between py-4 mt-4 delimiter-top">
                <div class="col-md-6">
                    <div class="copyright text-sm font-weight-bold text-center text-md-left">
                        &copy; 2018-2019 <a
                            href="https://preview.webpixels.io/purpose-website-ui-kit/https://webpixels.io"
                            class="font-weight-bold" target="_blank">Webpixels</a>. All rights reserved.
                    </div>
                </div>
                <div class="col-md-6">
                    <ul class="nav justify-content-center justify-content-md-end mt-3 mt-md-0">
                        <li class="nav-item">
                            <a class="nav-link"
                                href="https://preview.webpixels.io/purpose-website-ui-kit/https://dribbble.com/webpixels"
                                target="_blank">
                        ...
                        <li class="nav-item">
                            <a class="nav-link"
                                href="https://preview.webpixels.io/purpose-website-ui-kit/https://www.instagram.com/webpixelsofficial"
                                target="_blank">
                        ...
                        <li class="nav-item">
                            <a class="nav-link"
                                href="https://preview.webpixels.io/purpose-website-ui-kit/https://github.com/webpixels"
                                target="_blank">
                        ...
                        <li class="nav-item">
                            <a class="nav-link"
                                href="https://preview.webpixels.io/purpose-website-ui-kit/https://www.facebook.com/webpixels"
                                target="_blank">
