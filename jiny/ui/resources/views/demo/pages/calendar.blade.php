            ...
            <x-card>
                ...
                <x-card-body>
                    <div id="fullcalendar" class="fc fc-media-screen fc-direction-ltr fc-theme-bootstrap">
                        ...
                        <div class="fc-view-harness fc-view-harness-active" style="height: 608.148px;">
                                            ...
                                            <td>
                                                <div class="fc-scroller-harness">
                                                    <div class="fc-scroller" style="overflow: hidden;">
                                                        <table class="fc-col-header " style="width: 820px;">
                                                            <colgroup></colgroup>
                                                            <tbody>
                                                                <tr>
                                                    ...
                                                    <div class="fc-scroller fc-scroller-liquid-absolute"
                                                        ...
                                                        <div class="fc-daygrid-body fc-daygrid-body-unbalanced "
                                                            ...
                                                            <table class="fc-scrollgrid-sync-table"
                                                                style="width: 820px; height: 576px;">
                                                                <colgroup></colgroup>
                                                                <tbody>
                                                                    <tr>
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div class="fc-daygrid-day-events">
                                                                                    <div class="fc-daygrid-event-harness fc-daygrid-event-harness-abs"
                                                                                        style="top: 0px; left: 0px; right: -234px;">
                                                                                        <a
                                                                                            class="fc-daygrid-event fc-daygrid-block-event fc-h-event fc-event fc-event-start fc-event-end">
                                                                                            <div class="fc-event-main">
                                                                                                <div
                                                                                                    class="fc-event-main-frame">
                                                                                                    <div
                                                                                ...
                                                                                <div class="fc-daygrid-day-events">
                                                                                    <div class="fc-daygrid-event-harness"
                                                                                        style="margin-top: 22px;"><a
                                                                                            class="fc-daygrid-event fc-daygrid-dot-event fc-event fc-event-start fc-event-end fc-event-today">
                                                                                            <div
                                                                                                class="fc-daygrid-event-dot">
                                                                                            </div>
                                                                                            <div class="fc-event-time">4p
                                                                                            </div>
                                                                    ...
                                                                    <tr>
                                                                        <td class="fc-daygrid-day fc-day fc-day-sun fc-day-future"
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div class="fc-daygrid-day-events">
                                                                                    <div class="fc-daygrid-event-harness fc-daygrid-event-harness-abs"
                                                                                        style="top: 0px; left: 0px; right: -117px;">
                                                                                        <a
                                                                        ...
                                                                        <td class="fc-daygrid-day fc-day fc-day-mon fc-day-future"
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div class="fc-daygrid-day-events">
                                                                                    <div class="fc-daygrid-event-harness"
                                                                                        style="margin-top: 22px;"><a
                                                                                            class="fc-daygrid-event fc-daygrid-dot-event fc-event fc-event-start fc-event-end fc-event-future">
                                                                                            <div
                                                                                                class="fc-daygrid-event-dot">
                                                                                            </div>
