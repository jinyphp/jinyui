            ...
            <x-row>
                ...
                <x-col-6>
                    <x-card>
                        ...
                        <x-card-body class="flex flex-row gap-2">
                            @include("jinyui::demo.toggle.dropdown.group")
                ...
                <x-col-6>
                    <x-card>
                        ...
                        <x-card-body class="flex flex-row gap-2">
                            @include("jinyui::demo.toggle.dropdown.split")
                ...
                <x-col-6>
                    <x-card>
                        ...
                        <x-card-body class="flex flex-row gap-2">
                            @include("jinyui::demo.toggle.dropdown.size")
                ...
                <x-col-6>
                    <x-card>
                        ...
                        <x-card-body>
                            @include("jinyui::demo.toggle.dropdown.dark")
                ...
                <x-col-6>
                    <x-card>
                        ...
                        <x-card-body>
                            @include("jinyui::demo.toggle.dropdown.nav")
                        </x-card-body>
                    </x-card>
                </x-col-6>
                ...
                <x-col-6>
                    <x-card>
                        ...
                        <x-card-body>
                            @include("jinyui::demo.toggle.dropdown.direction")
                        ...
                        <x-card-body>
                            <div class="row mb-3">
                                <div class="col-12 col-md-6 col-lg-12 col-xl-6 col-xxl-4">
                                    ...
                                    @include("jinyui::demo.toggle.dropdown.menu-basic")
                                </div>
                                <div class="col-12 col-md-6 col-lg-12 col-xl-6 col-xxl-4">
                                    <p class="mb-0">Active:</p>
                                    @include("jinyui::demo.toggle.dropdown.menu-active")
                                </div>
                                <div class="col-12 col-md-6 col-lg-12 col-xl-6 col-xxl-4">
                                    <p class="mb-0">Disabled:</p>
                                    @include("jinyui::demo.toggle.dropdown.menu-disable")
                                </div>
                        ...
                        <x-card-body>
                            <div class="row mb-3">
                                <div class="col-12 col-md-6 col-lg-12 col-xl-6 col-xxl-4">
                                    ...
                                    @include("jinyui::demo.toggle.dropdown.menu-header")
                                </div>
                                <div class="col-12 col-md-6 col-lg-12 col-xl-6 col-xxl-4">
                                    <p class="mb-0">Dividers:</p>
                                    @include("jinyui::demo.toggle.dropdown.menu-devider")
                                    
                                </div>
                                <div class="col-12 col-md-6 col-lg-12 col-xl-6 col-xxl-4">
                                    <p class="mb-0">Text:</p>
                                    @include("jinyui::demo.toggle.dropdown.menu-text")
                                </div>
                            </div>
                        </x-card-body>
                    </x-card>
