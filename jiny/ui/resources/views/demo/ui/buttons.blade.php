				...
				<div class="row">
					<div class="col-12 col-lg-6">
						<div class="card">
							...
							<div class="card-body text-center">
								<div class="mb-3">
									<x-jiny-button class="btn-primary">Primary</x-jiny-button>
								...
								<div>
									<x-jiny-button class="btn-primary" disabled="">Primary</x-jiny-button>
					...
					<div class="col-12 col-lg-6">
						<div class="card">
							...
							<div class="card-body text-center">
								<div class="mb-3">
									<x-jiny-button class="btn-pill btn-primary">Primary</x-jiny-button>
