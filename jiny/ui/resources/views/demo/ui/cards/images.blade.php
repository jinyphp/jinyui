        ...
        <x-container>
        	...
        	<x-row >
            	<x-col class="col-8">
                	<div class="page-title-box">                        
        				...
        				<div class="mb-3">
                        	<h1 class="h3 d-inline align-middle">Card with Images</h1>
            ...
            <x-row>
                <div class="col-lg-3 col-md-6">
                    <div class="mb-4 card">
                        <img class="card-img-top" src="/img/mockup1.jpg"
                            alt="Card image cap">
                        <div class="card-body">
                            <div class="card-title h5">Card title</div>
                            <p class="card-text">Some quick example text to build on the card title and make up
                                the bulk of the card's content.</p><a href="#" class="btn btn-primary"
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="mb-4 card">
                        <img class="card-img-top" src="/img/mockup3.jpg"
                            alt="Card image cap">
                        <div class="card-body">
                            <div class="card-title h5">Card title</div>
                            <p class="card-text">Some quick example text to build on the card title and make up
                        ...
                        <div class="card-body"><a class="card-link" href="#">Card link</a><a class="card-link"
                                href="#">Another link here</a></div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="mb-4 card">
                        <img class="card-img-top" src="/img/mockup4.jpg"
                            alt="Card image cap">
                        <div class="card-body">
                            <p class="card-text">Some quick example text to build on the card title and make up
                                the bulk of the card's content.</p>
            ...
            <x-row>
                <div class="col-lg-4 col-md-6">
                    <div class="mb-4 card"><img class="card-img-top" src="/img/mockup6.jpg"
                            alt="Card image cap">
                        <div class="card-body">
                            <div class="card-title h5">Card title</div>
                            <div class="text-muted card-subtitle h6">Support card subtitle</div>
                    ...
                    <div class="mb-4 card">
                        <div class="card-body">
                            ...
                            <p class="card-text">Some quick example text to build on the card title and make up
                                the bulk of the card's content.</p>
                            <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
                        </div><img class="card-img-bottom" src="/img/mockup4.jpg" alt="Card image cap">
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="card-inverse text-white  mb-4 card"><img class="card-img"
                            src="/img/mockup4.jpg">
