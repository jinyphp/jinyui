<x-jinyui-theme theme="adminkit" class="bootstrap">
    ...
    <div class="container-fluid p-0">
        ...
        <div class="mb-3">
            <h1 class="h3 d-inline align-middle">Nav-Tabs</h1><a class="badge bg-primary ms-2" href="https://adminkit.io/pricing/" target="_blank">Pro
        ...
        <div class="row">
            <div class="col-12 col-lg-6">
                nav-tabs
                <div class="tab">
                <x-jinyui::nav.tab class="nav-tabs">
                    ...
                    <x-jinyui::nav.tab-item >
                        <x-jinyui::nav.tab-link href="#tab-2">Profile</x-jinyui::nav.tab-link> 
                    ...
                    <x-jinyui::nav.tab-item >
                        <x-jinyui::nav.tab-link href="#tab-3">Messages</x-jinyui::nav.tab-link>
                    ...
                    <x-jinyui::nav.tab-item >
                        <x-jinyui::nav.tab-link href="#tab-4" class="disabled">Disable</x-jinyui::nav.tab-link>
            ...
            <div class="col-12 col-lg-6">
                nav-pills
                <div class="tab">
                <x-jinyui::nav.tab class="nav-pills">
            ...
            <div class="col-12 col-lg-6">
                Fill and justify
                <div class="tab">
                <x-jinyui::nav.tab class="nav-pills nav-fill">
