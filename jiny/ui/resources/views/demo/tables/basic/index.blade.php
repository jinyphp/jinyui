    ...
    <div class="main">
        <main class="content">
            <div class="container-fluid p-0">
                ...
                <h1 class="h3 mb-3">Tables Basic</h1>

                <div class="row">
                    <div class="col-12 col-xl-6 bg-white p-4">
                        <h3 class="h4 mb-3"> 기본내용</h3>
                        @include("jinyui::demo.tables.basic.table-basic")                        
                    </div>

                    <div class="col-12 col-xl-6 bg-white p-4">
                        <h3 class="h4 mb-3"> bordered</h3>
                    ...
                    <div class="col-12 col-xl-6 bg-white p-4">
                        <h3 class="h4 mb-3"> color borders</h3>
                    ...
                    <div class="col-12 col-xl-6 bg-white p-4">
                        <h3 class="h4 mb-3"> without borders</h3>
