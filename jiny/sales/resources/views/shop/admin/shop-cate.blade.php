...
<table border="0" width="1200" cellspacing="0" cellpadding="0">
	<tr>
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			<tr>
				<td style="border-bottom:1px solid #E9E9E9;font-size:12px;padding:10px;" width="60">
				&nbsp;</td>
				...
				&nbsp;</td>
				<td style="border-bottom:1px solid #E9E9E9;font-size:12px;padding:10px;" width="80" align=right>
				 </td>
				<td style="border-bottom:1px solid #E9E9E9;font-size:12px;padding:10px;" width="80" align=right>
				 </td>
				<td style="border-bottom:1px solid #E9E9E9;font-size:12px;padding:10px;" width="80" align=right> </td>
			</tr>
			</table>
		<p>{datalist}<p>{formend}</td>
	</tr>
	</table>
