        	...
        	<x-row >
            	<x-col class="col-8">
                	<div class="page-title-box">                        
        				...
        				<div class="mb-3">
                        	<h1 class="h3 d-inline align-middle">사이트 : 사이트 레이아웃 설정</h1>
                            <p>
						...
						<x-card-body>
							<x-row>
								<table border="0" width="100%" cellspacing="0" cellpadding="0">
									<tr>
										<td style="font-size:12px;padding:10px;" >도메인별 사이트 레이아웃을 설정할 수
										있습니다.</td>
										<td style="font-size:12px;padding:10px;" width="80">검색:</td>
										<td style="font-size:12px;padding:10px;" width="150">{search_key}</td>
