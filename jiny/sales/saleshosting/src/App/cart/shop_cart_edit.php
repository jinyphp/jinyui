<?php
	...
	if(isset($_COOKIE['cookie_email'])){
		...
		$themepages = "shop_cart_edit";
		$body = str_replace("id=\"mainbody\"", "class=\"$themepages\" id=\"mainbody\"", $body);
		...
		$body = str_replace("<!--{skin_emptybody}-->","
					...
					<form name='shop' method='post' enctype='multipart/form-data'>
					   ...
					   <input type='hidden' name='uid' value='$uid'>
						...
						<script>"._javascript_ajax_html("#mainbody","ajax_shop_cart_edit.php")."</script>				
					</form>",$body);
