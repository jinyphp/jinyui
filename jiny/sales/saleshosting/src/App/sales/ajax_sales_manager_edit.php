<?
	...
	if(isset($_SESSION['ajaxkey']) == $ajaxkey) { // Ajax CallKey Securities Checking...
		...
		$body = $javascript._theme_page($site_env->theme,"sales_manager_edit",$site_language,$site_mobile);
		...
		// $body = str_replace("{level}","<input type='text' name='level'  value='".$rows->level."' style=\"$css_textbox\">",$body);

		$body = str_replace("{parts}",_sales_managerPart_OnSelect($rows->part),$body);
		$body = str_replace("{level}",_sales_managerLevel_OnSelect($rows->level),$body);
