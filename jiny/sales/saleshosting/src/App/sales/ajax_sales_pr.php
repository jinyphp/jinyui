<?
	...
	$javascript = "<script>
		function mode(mode,uid,limit){
			var url = \"ajax_sales_pr_editup.php\";
	...
	if(isset($_SESSION['ajaxkey']) == $ajaxkey) { // Ajax CallKey Securities Checking...
		...
		$body = $javascript._theme_page($site_env->theme,"sales_pr",$site_language,$site_mobile);
