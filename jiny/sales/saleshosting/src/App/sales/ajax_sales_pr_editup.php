<?
	...
	if(isset($_SESSION['ajaxkey']) == $ajaxkey) { // Ajax CallKey Securities Checking...
		...
		if($mode == "delete"){
    		...
    		$query = "DELETE FROM sales_pr WHERE `Id`='$uid'";
    		_sales_query($query);
			...
			if($rows = _sales_query_rows($query)){
				...
				$query = "INSERT INTO sales_pr ($insert_filed) VALUES ($insert_value)";
		...
		$url = "sales_pr.php"."?limit=$limit&searchkey=$search&list_num=".$list_num;    		
