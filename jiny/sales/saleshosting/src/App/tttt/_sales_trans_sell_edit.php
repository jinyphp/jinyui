				...
				switch($mode){
					case 'editup':
    					...
    					if( mysql_num_rows($result1) ) {
    						...
    						$balance1 = $rows1[balance1] + $rows[prices_total] - $prices_total;
						...
						echo "<meta http-equiv='refresh' content='0; url=sales_trans_sell.php?company_id=$rows[UIDB]&transdate=$rows[transdate]'>";

						break;
					default:			
						$body = shopskin("sales_trans_sell_edit");
						...
						$body = str_replace("{submit}","<input type='submit' value='수정' $butten_style>",$body);
