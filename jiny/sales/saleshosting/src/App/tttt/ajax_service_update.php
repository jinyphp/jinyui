<?
	...
	$javascript = "<script>
		function update_database(){
			//alert(\"update\");
			var url = \"/ajax_service_update_database.php\";
			// popup(url);
		...
		function update_file(){
			//alert(\"update\");
			var url = \"/ajax_service_update_file.php\";
			// popup(url);
	...
	if(isset($_SESSION['ajaxkey']) == $ajaxkey) { // Ajax CallKey Securities Checking...
		...
		$body = $javascript._skin_page($skin_name,"service_update");
		...
		$button ="<input type='button' value='DB 업데이트' onclick=\"javascript:update_database()\" style=\"".$css_btn_gray."\" >";          
		$body = str_replace("{update_database}",$button,$body);

		$button ="<input type='button' value='file 업데이트' onclick=\"javascript:update_file()\" style=\"".$css_btn_gray."\" >";          
		$body = str_replace("{update_file}",$button,$body);
