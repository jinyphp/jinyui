<?
	...
	if(isset($_SESSION['ajaxkey']) == $ajaxkey) { // Ajax CallKey Securities Checking...
		...
		if($mode == "new"){
			...
			$urlmode = "<select name='urlmode' id=\"urlmode\" onchange=\"javascript:urlmode_change()\">
			...
			$body = str_replace("{url}","<span id=\"url_list\"><input type='text' name='url' id=\"cssFormStyle\"></span>",$body);
