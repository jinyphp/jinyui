<?
	...
	$javascript = "<script>
		...
		function edit(mode,uid){
			//var url = \"/hosting_plan_edit.php?mode=\" + mode + \"&uid=\" + uid;
			...
			/*
            $.ajax({
                url:'/ajax_service_products_edit.php?uid='+uid+'&mode='+mode,
                type:'post',
                data:$('form').serialize(),
        ...
        function list(limit){
        	var url = \"/ajax_hosting_plan.php?limit=\"+limit;
	...
	if(isset($_SESSION['ajaxkey']) == $ajaxkey) { // Ajax CallKey Securities Checking...
			...
			$query = "select * from `service_products` where reseller = '$email' ";
			...
			if($rowss = _mysqli_query_rowss($query)){
				...
				$list = "<table border=\"0\" width=\"100%\" cellspacing=\"0\" cellpadding=\"0\">
							...
							<td style='border-top:1px solid #E9E9E9;font-size:12px;padding:10px;' >타이틀</td>
							<td style='border-top:1px solid #E9E9E9;font-size:12px;padding:10px;' width='80'>레벨</td>
							<td style='border-top:1px solid #E9E9E9;font-size:12px;padding:10px;' width='80'>마진</td>
							<td style='border-top:1px solid #E9E9E9;font-size:12px;padding:10px;' width='80'>설정비</td>
							<td style='border-top:1px solid #E9E9E9;font-size:12px;padding:10px;' width='80'>유지비</td>
							</tr>
						</table>";
				...
				for($i=0;$i<$count;$i++){
					...
					$title_name = "<a href='#' onclick=\"javascript:edit('edit','".$rows->Id."')\">".$rows->title."</a>";
					...
					$list .= "<table border=\"0\" width=\"100%\" cellspacing=\"0\" cellpadding=\"0\">
							...
							<td style='border-top:1px solid #E9E9E9;font-size:12px;padding:10px;' width='80'>".$rows->level."</td>
							<td style='border-top:1px solid #E9E9E9;font-size:12px;padding:10px;' width='80'>".$rows->margin."</td>
