<?
	...
	$javascript = "<script>
		...
		function edit(mode,uid){
			...
			/*
            $.ajax({
                url:'/ajax_reseller_program_edit.php?uid='+uid+'&mode='+mode,
                type:'post',
                data:$('form').serialize(),
	...
	if(isset($_SESSION['ajaxkey']) == $ajaxkey) { // Ajax CallKey Securities Checking...
			...
			$body = $javascript._skin_page($skin_name,"reseller_program");
			...
			$query = "select * from `service_reseller_program` where reseller = '$email' ";
