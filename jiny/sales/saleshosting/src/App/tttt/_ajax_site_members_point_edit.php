	...
	if(isset($_SESSION['ajaxkey']) == _formdata("ajaxkey")) { // Ajax CallKey Securities Checking...
		...
		$javascript = "<script>
				...
				function form_submit(mode,uid){
					var url = \"/ajax_site_members_point_editup.php?uid=\"+uid+\"&mode=\"+mode;
		...
		$body = $javascript._skin_page($skin_name,"site_members_point_edit");
		...
		if(isset($rows->point)) $point = $rows->point; else $point ="";
		$body = str_replace("{point}",_form_text("point",$point,$css_textbox),$body);
