	...
	if(isset($_COOKIE['cookie_email'])){
		...
		$javascript = "<script>
			function setup(mode){
				...
				document.resales.submit();
			}
		</script>";
	
		// $body = $javascript._skin_body($skin_name,"resales_setup");
		...
		$body=str_replace("{formstart}","<form id='data' name='resales' method='post' enctype='multipart/form-data' action='".$_SERVER['PHP_SELF']."'> 
