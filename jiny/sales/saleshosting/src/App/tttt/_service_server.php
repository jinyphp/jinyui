<?
	...
	if(isset($_COOKIE['cookie_email'])){
		...
		// $javascript = "<script>"._javascript_ajax_html("#mainbody","/ajax_service_server.php?ajaxkey=$ajaxkey")."</script>";			
		...
		$javascript .= "<script>"._javascript_ajax_html("#mainbody","/ajax_service_server.php")."</script>";			
		$javascript .= "</form>";
