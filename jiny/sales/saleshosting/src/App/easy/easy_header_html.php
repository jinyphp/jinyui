<?
	...
	*/
		...
		$title = "EASY 헤더 설정";
		$body = $javascript._popup_body( $title, $width, _theme_popup($site_env->theme,"easy_header_html",$site_language,$site_mobile) );
		...
		$query = "select * from site_themefiles WHERE `filename`='header' and `theme`='".$site_env->theme."'";
		// echo $query."<br>";
