<?
	...
	*/
		...
		$title = "EASY 하단 설정";
		$body = $javascript._popup_body( $title, $width, _theme_popup($site_env->theme,"easy_footer_html",$site_language,$site_mobile) );
		...
		$query = "select * from site_themefiles WHERE `filename`='footer' and `theme`='".$site_env->theme."'";
		// echo $query."<br>";
