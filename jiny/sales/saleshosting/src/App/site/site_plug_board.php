	...
	if(isset($_COOKIE['cookie_email'])){
		...
		$body = str_replace("<!--{skin_emptybody}-->","
					...
					<form name='goods' method='post' enctype='multipart/form-data'>
						...
						<script>"._javascript_ajax_html("#mainbody","ajax_site_plug_board.php")."</script>				
					</form>",$body);
		echo $body;
		...
		$javascript .= "<script>"._javascript_ajax_html("#mainbody","/ajax_site_index_board.php")."</script>";	
		$javascript .= "</form>";		
