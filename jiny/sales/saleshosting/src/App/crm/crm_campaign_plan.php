<?php
	...
	if(isset($_COOKIE['cookie_email'])){
		...
		// 환경설정 읽어보기
		require_once ($_SERVER['DOCUMENT_ROOT']."/crm/crm_campaign_plan.cfg.php");

		// 테이블 및 데이터 베이스 체크
		require_once ($_SERVER['DOCUMENT_ROOT']."/crm/inc.table_check.php");
		...
		$submenuID = _submenuId_byurl($_SERVER['REQUEST_URI']);
		$hidden .= "<input type='hidden' name='submenu_id' value='".$submenuID."'>";
		// echo "submenu ID:".$submenuID."<br>";
