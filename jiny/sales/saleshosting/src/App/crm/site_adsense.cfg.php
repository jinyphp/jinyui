<?php
	...
	$_tableField = json_decode('[
    	...
    	{"field":"adsense","type":"varchar(255)","default":"DEFAULT NULL"},
        {"field":"source","type":"text","default":"DEFAULT NULL"},
    ...
    $_form = json_decode('[
        ...
        {"str":"{adsense}","name":"adsense","type":"input","default":"","require":"on","msg":"광고 코드를 입력해 주세요"},
        {"str":"{source}","name":"source","type":"textarea","default":"","require":"","msg":""},
    ...
    */ 
	...
	$_titleName = json_decode('[
        ...
        {"title":"<i class=\"fa fa-sort-amount-desc\" aria-hidden=\"true\"></i> 에드센스","width":"","field":"adsense"}
    ]',true);

	//+ 목록이 출력할 값이 없을 경우 표시할 문구
	$noListMsg = "adsense 목록 없습니다.";

	$_block_num = 10;

	//+ 검색시 필터링할 필드명
	$_search_keyField = "adsense";
