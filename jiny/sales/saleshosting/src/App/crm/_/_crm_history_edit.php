<?
	...
	if(isset($_COOKIE['cookie_email'])){
		...
		$ajaxScript = "<script>"._javascript_ajax_html("#mainbody","ajax_".$_tableName."_edit.php")."</script>";
		$body = str_replace("<!--{skin_emptybody}-->","
					<center><img src='../images/loading.gif' border='0'></center>
					<form name='goods' method='post' enctype='multipart/form-data'>".$hidden.$ajaxScript."										
					</form>",$body);
