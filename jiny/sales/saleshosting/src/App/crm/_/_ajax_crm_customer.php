<?
	...
	if(isset($_SESSION['ajaxkey']) == $ajaxkey) { // Ajax CallKey Securities Checking...
		...
		$body = str_replace("<!--{#side_menu}-->", _submenu("default",$site_language,536),$body);
		...
		if($rowss = _sales_query_rowss($query)){
			...
			for($i=0;$i<$count;$i++){
				...
				$history = "<a href='crm_history.php?customer=".$rows->Id."'>상담내역</a>";
				$license = "<a href='crm_license.php?customer=".$rows->Id."'>라이센스</a>";
