<?
	...
	$javascript = "<script>
		function mode(mode,uid,limit){
			var url = \"ajax_seller_setup_editup.php\";
	...
	if(isset($_SESSION['ajaxkey']) == $ajaxkey) { // Ajax CallKey Securities Checking...
		...
		$body = $javascript._theme_page($site_env->theme,"scm_seller_setup",$site_language,$site_mobile);
		...
		$list .= "<td style='border-bottom:1px solid #E9E9E9;font-size:12px;padding:10px;' width='100'>등록일자</td>
					  ...
					  <td style='border-bottom:1px solid #E9E9E9;font-size:12px;padding:10px;' width='100'>SCM</td>
					  <td style='border-bottom:1px solid #E9E9E9;font-size:12px;padding:10px;' width='100'>커미션</td>
					  <td style='border-bottom:1px solid #E9E9E9;font-size:12px;padding:10px;' width='100'>공급망</td>
					  <td style='border-bottom:1px solid #E9E9E9;font-size:12px;padding:10px;' width='100'>입점망</td>
					  </tr>
					</table>";
		...
		if($rowss = _sales_query_rowss($query)){
			...
			for($i=0;$i<$count;$i++){
				...
				$list .= "<td style='border-bottom:1px solid #E9E9E9;font-size:12px;padding:10px;' width='100'>".$rows->regdate."</td>
						  ...
						  <td style='border-bottom:1px solid #E9E9E9;font-size:12px;padding:10px;' width='100'>".$rows->scm."</td>
						  <td style='border-bottom:1px solid #E9E9E9;font-size:12px;padding:10px;' width='100'>".$rows->scm_comission."%</td>
							<td style='border-bottom:1px solid #E9E9E9;font-size:12px;padding:10px;' width='100'>".$rows->scm_shop."</td>
						  <td style='border-bottom:1px solid #E9E9E9;font-size:12px;padding:10px;' width='100'>".$rows->scm_seller."</td>
							</tr>
						</table>";				
