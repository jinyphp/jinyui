<?
	...
	if(isset($_COOKIE['cookie_email'])){
		...
		$body = $javascript._theme_page($site_env->theme,"scm_seller_company_edit",$site_language,$site_mobile);
		...
		if($scm_rows = _sales_query_rows($query1)){
			...
			$query1 = "select * from seller where email = '".$scm_rows->seller_email."' and business = '".$scm_rows->seller_business."' ";
