<?
	...
	if($_COOKIE[adminemail]){ ///////////////
		...
		$body=str_replace("{formstart}","<form name='memauth' method='post' enctype='multipart/form-data' action='admin_memlist_newup.php'> 
					    				<input type='hidden' name='nonce' value='$nonce'>
					    				<input type='hidden' name='mode' value='newup'>",$body);
		$body = str_replace("{formend}","</form>",$body);
					 
		$body = str_replace("{memauth}","<input type='checkbox' name='auth' >",$body);
		...
		$body = str_replace("{email}","<input type='email' name='email' autofocus required $cssFormStyle>",$body);
		$body = str_replace("{phone}","<input type='text' name='phone' required $cssFormStyle>",$body);
		$body = str_replace("{password}","<input type='password' name='password' required $cssFormStyle>",$body);
		$body = str_replace("{name}","<input type='text' name='name' required $cssFormStyle>",$body);
		...
		$body = str_replace("{point}","<input type='text' name='point' $cssFormStyle>",$body);
		$body = str_replace("{money}","<input type='text' name='money' $cssFormStyle>",$body);
