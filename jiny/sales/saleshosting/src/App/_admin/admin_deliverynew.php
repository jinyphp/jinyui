<?
	...
	if($_COOKIE[adminemail]){ ///////////////
    			...
    			$body = admin_shopskin("admin_deliveryknew");
    					
    			$body=str_replace("{formstart}","<form name='country1' method='post' enctype='multipart/form-data' action='admin_deliverynewup.php'> 
				...
				$body = str_replace("{name}","<input type='text' name='company'  $cssFormStyle >",$body);
				$body = str_replace("{charge}","<input type='text' name='charge'  $cssFormStyle >",$body);
