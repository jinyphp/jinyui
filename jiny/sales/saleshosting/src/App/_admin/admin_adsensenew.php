<?
	...
	if($_COOKIE[adminemail]){ ///////////////
    			...
    			$body = admin_shopskin("admin_adsensenew");
    					
    			$body=str_replace("{formstart}","<form name='adsense' method='post' enctype='multipart/form-data' action='admin_adsensenewup.php'> 
				...
				$body = str_replace("{html}","<textarea name='html' rows='10' style='width:100%'></textarea>",$body);
