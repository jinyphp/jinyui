<?
	...
	if($_COOKIE[adminemail]){ ///////////////
		...
		$body = admin_shopskin("admin_partnernew");		
    		
		$body=str_replace("{formstart}","<form name='manager' method='post' enctype='multipart/form-data' action='admin_partnernewup.php'> 
