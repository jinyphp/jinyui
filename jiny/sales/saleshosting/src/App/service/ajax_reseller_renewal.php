<?
	...
	if(isset($_SESSION['ajaxkey']) == $ajaxkey) { // Ajax CallKey Securities Checking...
			...
			$body = $javascript._theme_page($site_env->theme,"service_reseller_renewal",$site_language,$site_mobile);
			...
			if($reseller = _is_reseller($email)){
				// 리셀러 : 하부 리셀러 관리
				$query = "select * from service.reseller_renewal where reseller = '$email' ";
			} else {
