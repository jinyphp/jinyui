<?php
	...
	// if(isset($_COOKIE['cookie_email'])){
		...
		// $skin_name = "default";
		$body = _skin_body($skin_name,"site_header");
		...
		$script = "
				...
				function site_edit(mode,uid){
                  	var url = \"/ajax_admin_header_edit.php?uid=\"+uid+\"&mode=\"+mode;	
                  	$.ajax({
                        url:url,
                        type:'post',
                        data:$('form').serialize(),
				...
				function form_submit(mode,uid){
					var url = \"/ajax_admin_header_editup.php?mode=\"+mode+\"&uid=\"+uid;
		...
		$body=str_replace("{formstart}",$script."<form id='data' name='header' method='post' enctype='multipart/form-data' action='".$_SERVER['PHP_SELF']."'> 
