<?
	...
	$javascript = "<script>
		...
		function form_submit(mode,uid){
			var url = \"ajax_site_members_reserved_editup.php?uid=\"+uid+\"&mode=\"+mode;
	...
	if(isset($_SESSION['ajaxkey']) == $ajaxkey) { // Ajax CallKey Securities Checking...
		...
		$body = $javascript._theme_page($site_env->theme,"site_members_reserved_edit",$site_language,$site_mobile);
		...
		//////////////////
		if($rows = _site_memberReservedRows_Id($uid)){
