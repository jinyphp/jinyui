<?
	...
	$javascript = "<script>
		function mode(mode,uid,limit){
			var url = \"ajax_shop_payment_editup.php\";
	...
	if(isset($_SESSION['ajaxkey']) == $ajaxkey) { // Ajax CallKey Securities Checking...
		...
		// 스킨템플릿 읽어오기
		// $body = $javascript._skin_page($skin_name,"shop_payment");
		$body = $javascript._theme_page($site_env->theme,"shop_payment",$site_language,$site_mobile);
		...
		$query = "select * from `shop_payment` ";
		if($rowss = _sales_query_rowss($query)){	

			$list .= "<table border=\"0\" width=\"100%\" cellspacing=\"0\" cellpadding=\"0\">
					<tr>
					<td style='border-bottom:1px solid #E9E9E9;font-size:12px;padding:10px;' width=\"100\">코드</td>	
			...
			for($i=0,$total_prices=0,$sub_prices=0; $i<count($rowss); $i++){
				...
				$list .= "<table border=\"0\" width=\"100%\" cellspacing=\"0\" cellpadding=\"0\">
					<tr>
					<td style='border-bottom:1px solid #E9E9E9;font-size:12px;padding:10px;' width=\"100\">$enable ".$rows->code."</td>
					<td style='border-bottom:1px solid #E9E9E9;font-size:12px;padding:10px;' width=\"150\"><a href='#' onclick=\"javascript:edit('edit','".$rows->Id."')\" >".$rows->payment."</a></td>			
