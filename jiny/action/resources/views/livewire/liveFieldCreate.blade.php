<div>
    ...
    <x-form method="post">
        ...
        <x-nav class="nav-pills bg-nav-pills mb-3 nav-justified">
            <x-nav-item>
                @if ($_tabs == 0)
                    <a href="#bordered-tabs-preview" 
                    data-bs-toggle="tab" aria-expanded="false" 
                    class="nav-link rounded-0 active" wire:click="tab(0)">
                    List {{$_tabs}}
                    </a>
                @else 
                    <a href="#bordered-tabs-preview" 
                        data-bs-toggle="tab" aria-expanded="false" 
                        class="nav-link rounded-0" wire:click="tab(0)">
                        List {{$_tabs}}
                    </a>
                @endif
            ...
            <x-nav-item>
                @if ($_tabs == 1)
                    <a href="#bordered-tabs-code" 
                        ...
                        class="nav-link rounded-0 active" wire:click="tab(1)">
                        Form
                    </a>
                @else 
                    <a href="#bordered-tabs-code" 
                        data-bs-toggle="tab" aria-expanded="true" 
                        class="nav-link rounded-0" wire:click="tab(1)">
                        Form
                    </a>
                @endif
            </x-nav-item>                               
        ...
        <div class="tab-content">
            ...
            @else
            <div class="tab-pane show" id="bordered-tabs-preview">
            @endif

                {{--목록--}}
                <x-row>
                    <x-col class="col-12 col-md-6 col-lg-3 border-r">
                        <x-form-hor>
                    ...
                    <x-col class="col-12 col-md-6 col-lg-9">
                ...
                <x-row>
                    ...
                    <x-col class="col-12 col-md-6 col-lg-6 border-r">
                        <x-form-row>
                    ...
                    <x-col class="col-12 col-md-6 col-lg-9">
                        <x-form-row>
                            ...
                            <x-form-item>
                                {!! 
                                    xTextarea("list_value")
                                    ->setAttribute('wire:model.deafer',"_data.list_value")
                                !!}
            ...
            @if ($_tabs == 1)
            <div class="tab-pane active" id="bordered-tabs-code">
            @else
            ...
            @endif
                ...
                <x-row>
                    ...
                    <x-col class="col-12 col-md-6 col-lg-9 border-r">
                ...
                <x-row>
                    ...
                    <x-col class="col-12 col-md-6 col-lg-9 border-r">
                        ...
                        <x-form-row>
                            ...
                            <x-form-item>
                                <x-input type="text" name="default" wire:model="_data.default"/>
