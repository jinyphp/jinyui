...
class Reserved extends CrudController
{
    public $rules;
    public function __construct()
    {
        $this->tablename="site_members_reserved";
        $this->rules['tablename'] = $this->tablename;
        $this->rules['routename'] = explode(".", Route::currentRouteName())[0];

        $this->rules['view']['list'] = "jinymem::members.reserved.list";
        $this->rules['view']['edit'] = "jinymem::members.reserved.edit";
        $this->rules['view']['edit'] = "jinymem::members.reserved.edit";
