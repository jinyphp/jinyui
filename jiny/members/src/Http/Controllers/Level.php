...
class Level extends CrudController
{
    public $rules;
    public function __construct()
    {
        $this->tablename="site_members_level";
        $this->rules['tablename'] = $this->tablename;
        $this->rules['routename'] = explode(".", Route::currentRouteName())[0];

        $this->rules['view']['list'] = "jinymem::members.level.list";
        $this->rules['view']['edit'] = "jinymem::members.level.edit";
        $this->rules['view']['edit'] = "jinymem::members.level.edit";
