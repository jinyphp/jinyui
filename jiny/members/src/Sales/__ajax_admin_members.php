	...
	if(isset($_SESSION['ajaxkey']) == $ajaxkey) { // Ajax CallKey Securities Checking...
		...
		if($rowss = _sales_query_rowss($query)){
			...
			for($i=0;$i<$count;$i++){
				...
				$field_setting = "<i class=\"fa fa-cog\" aria-hidden=\"true\" style=\"color:#808080;\"></i>"." <a href='admin_tablesfield.php?table_name=".$rows->table_name."'>Field SET</a>";
				$list_setting = "<i class=\"fa fa-cog\" aria-hidden=\"true\" style=\"color:#808080;\"></i>"." <a href='admin_tableslist.php?table_name=".$rows->table_name."'>".$rows->listview_type."</a>";

				$service_link = "<a href='".$rows->table_name.".php'> <i class=\"fa fa-sign-in\" aria-hidden=\"true\"></i>"."</a>";
				$service_link = "";
