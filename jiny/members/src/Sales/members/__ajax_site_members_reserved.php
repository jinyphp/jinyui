<?
	...
	$javascript = "<script>
		...
		function mode(mode,uid,limit){
			var url = \"ajax_site_members_reserved_editup.php\";
		...
		function edit(mode,uid,limit){
			var url = \"site_members_reserved_edit.php\";
        ...
        function list(limit){
        	var url = \"ajax_site_members_reserved.php\";
        	var form = document.site;
        	form.limit.value = limit;
	...
	if(isset($_SESSION['ajaxkey']) == $ajaxkey) { // Ajax CallKey Securities Checking...
		...
		$body = $javascript._theme_page($site_env->theme,"site_members_reserved",$site_language,$site_mobile);
		...
		$query = "select * from `site_members_reserved` ";
		// echo $query."<br>";
		if($searchkey) {
